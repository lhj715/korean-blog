---
title: "2025년 10월 고2 국어 기출 분석"
category: "학력평가"
date: 2025-10-14
keywords: ["고2", "2025년 10월", "학력평가", "국어", "기출 분석", "근거 표시", "혼자 공부"]
summary: "2025년 10월 고2 전국연합학력평가 국어 기출 분석 — 지문에 선지 판단 근거를 표시하고 발문 해석·선지 판단·오답 함정까지 담은 풀이."
---
...
<div class="read-guide">
  ...
  <p>발표·화법은 <strong>무엇을 설명했나</strong>와 <strong>어떻게 설명했나</strong>를 따로 챙긴다. 이 발표는 세 생물의 번식 전략을 자료와 함께 설명한다.</p>
  <ul>
    <li><strong>심해 아귀</strong> — 수컷이 암컷에 융합되어 한 몸처럼. <strong>해마</strong> — 수컷이 육아낭으로 임신·출산. <strong>용치놀래기</strong> — 암컷이 수컷으로 <em>성별 변환</em>(큰 점 생김).</li>
    <li><strong>방식</strong> — ‘이게 어떻게 가능할까요?’처럼 <em>질문하고 스스로 답하는</em> 방식.</li>
  </ul>
  <p class="read-guide-tip"><strong>출제 포인트 예고</strong> — 2번은 자료 설명의 정확성(‘몸 크기’가 아니라 ‘성별 변환’), 3번은 청중 반응의 ‘종류’(탐색·아쉬움·의문)가 함정이다.</p>
</div>
...
<div class="passage">
  ...
  <p>다음으로 해마. 수컷이 임신·출산을 담당합니다. <span class="ev ans" id="ev1">이게 어떻게 가능한 일일까요? (㉡ 자료 제시) 배 부분의 ‘육아낭’ 덕분에 수컷이 임신·출산을 할 수 있습니다.</span><a class="ev-tag ans" href="#q1-4">1-④</a><a class="ev-tag" href="#q2-2">2-②</a> 암컷이 육아낭에 산란하면 수정·발달을 거쳐 새끼가 되고, <span class="ev" id="ev5">육아낭 내부의 ‘내층’은 배아를 감싸 외부 충격으로부터 보호합니다.</span><a class="ev-tag" href="#q2-3">2-③</a></p>
  <p>마지막으로 용치놀래기. 한 수컷이 여러 암컷을 이끄는 무리 생활을 하는데, 수컷이 사라지면 (㉢ 자료 제시) <span class="ev ans" id="ev2">무리에서 가장 큰 암컷이 수컷으로 변하고, 몸에 수컷의 특징인 큰 점이 생깁니다.</span><a class="ev-tag ans" href="#q2-4">2-④</a><a class="ev-tag" href="#q2-5">2-⑤</a></p>
...
<div class="q-block" id="prob1">
  ...
  <ul class="q-opts">
    ...
    <li id="q1-2">② 청중의 이해도를 확인하며 발표를 마무리하고 있다.<a class="src-tag ans" href="#ev1">지문 근거</a></li>
    <li id="q1-3">③ 대상에 대한 전문가의 평가를 직접 인용하여 제시하고 있다.<a class="src-tag ans" href="#ev1">지문 근거</a></li>
    <li id="q1-4">④ 질문하고 답하는 방식을 사용하여 발표 내용을 전달하고 있다.<a class="src-tag ans" href="#ev1">정답 근거</a></li>
    <li id="q1-5">⑤ 도입부에서 발표를 하게 된 소감을 밝히며 발표를 시작하고 있다.<a class="src-tag ans" href="#ev1">지문 근거</a></li>
  </ul>
  <details class="solution">
    ...
    <div class="solution-body">
      <div class="question-analysis">
        ...
        <p class="ask-read"><strong>발문 해석</strong> — 발표자의 ‘방식’이므로 실제로 한 말하기 행동을 본다.</p>
        <p>‘이게 어떻게 가능한 일일까요?’라고 묻고 ‘육아낭 덕분에…’라고 스스로 답하는 <strong>자문자답</strong> 방식으로 내용을 전달한다. ④가 맞다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>오답</td><td>청중의 경험을 환기하지 않는다.</td></tr>
          <tr><td>②</td><td>오답</td><td>이해도 확인으로 마무리하지 않는다.</td></tr>
          <tr><td>③</td><td>오답</td><td>전문가 평가 인용이 없다.</td></tr>
          <tr class="correct"><td>④</td><td class="ok">정답</td><td>질문→자답으로 내용을 전달한다.</td></tr>
          <tr><td>⑤</td><td>오답</td><td>소감을 밝히며 시작하지 않는다.</td></tr>
        </tbody>
      </table>
    </div>
  </details>
...
<div class="q-block" id="prob2">
  ...
  <ul class="q-opts">
    ...
    <li id="q2-2">② [자료2]를 ㉡에서 활용해, 육아낭으로 수컷 해마의 임신·출산이 이루어짐을 설명한다.<a class="src-tag ans" href="#ev1">지문 근거</a></li>
    ...
    <li id="q2-5">⑤ [자료3]을 ㉢에서 활용해, 암컷 하나가 수컷으로 바뀔 때 큰 점이 새로 생김을 설명한다.<a class="src-tag ans" href="#ev2">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        <div class="answer-line"><span>정답</span><strong>④</strong></div>
        <p class="ask-read"><strong>발문 해석</strong> — 각 선지가 발표 내용과 맞는지 본다. 특히 용치놀래기의 변화가 ‘무엇’인지 정확히.</p>
        <p>발표는 용치놀래기가 ‘암컷 → 수컷으로 <strong>성별이 변하고 큰 점이 생긴다</strong>’고 했지, <strong>몸 크기를 바꾼다</strong>고 하지 않았다. 따라서 ④가 적절하지 않다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>적절</td><td>아귀: 수컷이 암컷과 융합(한 몸).</td></tr>
          <tr><td>②</td><td>적절</td><td>해마: 육아낭으로 임신·출산.</td></tr>
          <tr><td>③</td><td>적절</td><td>내층이 배아를 보호.</td></tr>
          <tr class="correct"><td>④</td><td class="ok">부적절</td><td>‘몸 크기’가 아니라 ‘성별 변환’이다.</td></tr>
          <tr><td>⑤</td><td>적절</td><td>성별 변환 시 큰 점이 생긴다.</td></tr>
        </tbody>
      </table>
      <div class="trap">
        <div class="trap-head">조심할 점 — ‘무엇이’ 바뀌나</div>
        <p>④는 ‘크기’, ⑤는 ‘성별’이다. 발표가 말한 건 <strong>성별 변환</strong>(큰 점 생김). 비슷한 선지에서 핵심 단어 하나를 바꿔 함정을 판다.</p>
      </div>
    </div>
  </details>
</div>
...
<div class="q-block" id="prob3">
  ...
  <ul class="q-opts">
    <li id="q3-1">① 학생1은 발표 내용과 관련해 추가 정보를 탐색하려 한다.<a class="src-tag ans" href="#ev1">지문 근거</a></li>
    <li id="q3-2">② 학생2는 알고 싶은 정보가 발표에서 다뤄지지 않은 것을 아쉬워한다.<a class="src-tag ans" href="#ev1">지문 근거</a></li>
    <li id="q3-3">③ 학생3은 발표 정보를 유용성 측면에서 긍정적으로 평가한다.<a class="src-tag ans" href="#ev1">지문 근거</a></li>
    <li id="q3-4">④ 학생1·2 모두 발표 내용과 관련해 자신의 배경지식을 떠올린다.<a class="src-tag ans" href="#ev2">지문 근거</a></li>
    <li id="q3-5">⑤ 학생1·3 모두 발표 내용을 신뢰할 수 있는지 의문을 제기한다.<a class="src-tag ans" href="#ev2">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        <div class="answer-line"><span>정답</span><strong>⑤</strong></div>
        <p class="ask-read"><strong>발문 해석</strong> — 각 학생 반응의 ‘성격’(탐색·아쉬움·평가·배경지식·의문)을 분류해 대조한다.</p>
        <p>‘신뢰 의문’을 제기한 건 <strong>학생3뿐</strong>(‘정확한 걸까?’)이다. 학생1은 ‘방법이 궁금해 더 찾아본다’는 <strong>탐색</strong>이지 신뢰 의문이 아니다. 따라서 ⑤가 적절하지 않다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>적절</td><td>학생1: ‘더 찾아봐야겠어’ = 추가 탐색.</td></tr>
          <tr><td>②</td><td>적절</td><td>학생2: ‘좋았을 텐데’ = 아쉬움.</td></tr>
          <tr><td>③</td><td>적절</td><td>학생3: ‘도움이 되겠어’ = 유용성 긍정.</td></tr>
          <tr><td>④</td><td>적절</td><td>학생1(다큐)·학생2(책) = 배경지식 환기.</td></tr>
          <tr class="correct"><td>⑤</td><td class="ok">부적절</td><td>신뢰 의문은 학생3만. 학생1은 ‘탐색’이다.</td></tr>
        </tbody>
      </table>
      <div class="trap">
        <div class="trap-head">조심할 점 — ‘궁금함’ ≠ ‘의문 제기’</div>
        <p>학생1의 ‘어떻게 찾았을까?’는 더 알고 싶은 <strong>탐색</strong>이지, 발표가 틀렸다는 <strong>신뢰 의문</strong>이 아니다. 둘을 구분해야 ⑤가 보인다.</p>
      </div>
    </div>
  </details>
</div>
...
<div class="read-guide">
  <div class="read-guide-head">이 지문, 이렇게 읽는다</div>
  <p>(가) 회의 → (나) 초고로 이어지는 <strong>화작 복합</strong>이다. 회의에서 <strong>무엇이 결정됐고</strong>, 그것이 초고에 <strong>어떻게 반영됐는지</strong>를 짝지어 본다.</p>
  <ul>
    <li><strong>결정 사항</strong> — ① 대중가요 편곡 곡 ② 곡은 설문으로 선택 ③ 현대시 영감 곡 추가 요청 ④ 영상은 가능하나 조명 문제.</li>
  </ul>
  <p class="read-guide-tip"><strong>출제 포인트 예고</strong> — 6번은 회의 내용이 초고에 ‘빠짐없이’ 반영됐는지(조명 ‘문제점’ 누락), 7번은 고쳐쓰기 ‘조건’(장르 특성+의의+비유)이 함정이다.</p>
</div>
...
<div class="passage">
  ...
  <p class="dlg"><b>학생1:</b> <span class="ev" id="ev9">오늘은 답장에 들어갈 내용을 정하기 위해 회의를 하려고 해.</span><a class="ev-tag" href="#q4-1">4-①</a> <span class="ev" id="ev10">다들 내가 공유한 내용 보고 의견 정리해 왔지?</span><a class="ev-tag" href="#q4-2">4-②</a> 먼저 편곡 곡과 창작곡 중 어떤 게 좋을까?</p>
  ...
  <p class="dlg"><b>학생1:</b> 좋아, 편곡 곡으로 정하자. <span class="ev" id="ev11">다음으로 구체적인 곡을 선택하자. … 마지막으로, 공연 중 영상을 보여 줄 수 있는지도 물어왔어.</span><a class="ev-tag" href="#q4-3">4-③</a></p>
  <div class="seg"><span class="seg-label">[ B ]</span>
    <p class="dlg"><b>학생3:</b> 가능하긴 한데, 무대 조명이 밝아 영상이 흐리게 보일 거야.</p>
    <p class="dlg"><b>학생2:</b> <span class="ev ans" id="ev13">그래, 영상이 흐리게 보일 거야. … 합창 동아리도 공연 중 영상을 보여 준다고 했어. 어떻게 할 건지 물어보자.</span><a class="ev-tag ans" href="#q5-4">5-④</a></p>
  </div>
  <p class="dlg"><b>학생1:</b> <span class="ev" id="ev12">설문 조사 결과는 내일까지 보내 줘.</span><a class="ev-tag" href="#q4-4">4-④</a> 초고는 내가 써 올게.</p>
...
<div class="q-block" id="prob4">
  ...
  <ul class="q-opts">
    ...
    <li id="q4-5">⑤ 참여자의 발언과 관련해 추가 설명을 요청한다.<a class="src-tag" href="#ev4">정답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        <div class="answer-line"><span>정답</span><strong>⑤</strong></div>
        <p class="ask-read"><strong>발문 해석</strong> — 학생1(사회자)의 발화를 하나씩 확인한다. 적절하지 <strong>않은</strong> 하나를 찾는다.</p>
        <p>학생1은 목적 제시·준비 확인·이어 논의·이후 할 일 안내는 하지만, 어떤 발언에 <strong>추가 설명을 요청</strong>하는 장면은 없다. ⑤가 적절하지 않다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>적절</td><td>‘답장 내용 정하려 회의’ = 목적 제시.</td></tr>
...
<div class="q-block" id="prob5">
  ...
  <ul class="q-opts">
    ...
    <li id="q5-3">③ [B]에서 학생2는 학생3을 긍정하며 자신의 견해를 수정한다.<a class="src-tag ans" href="#ev13">지문 근거</a></li>
    <li id="q5-4">④ [B]에서 학생2는 학생3의 말을 일부 재진술하며 알고 있는 정보를 덧붙인다.<a class="src-tag ans" href="#ev13">정답 근거</a></li>
    <li id="q5-5">⑤ [A]·[B]의 학생3은 모두 고민을 언급하며 해결책을 제시한다.<a class="src-tag ans" href="#ev13">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        <div class="answer-line"><span>정답</span><strong>④</strong></div>
        <p class="ask-read"><strong>발문 해석</strong> — [A](편곡 논의)·[B](영상 논의)의 발화를 누가 무엇을 했는지로 본다.</p>
        <p>[B]에서 학생2는 학생3의 ‘영상이 흐리게 보일 거야’를 <strong>재진술</strong>하고, ‘합창 동아리도 영상을 보여 준다’는 <strong>아는 정보를 덧붙인다</strong>. ④가 맞다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>오답</td><td>[A] 학생3은 객관 자료를 제시하지 않는다.</td></tr>
          <tr><td>②</td><td>오답</td><td>[A] 학생3은 ‘듣고 보니 그렇네’로 동의할 뿐 근거 강조는 없다.</td></tr>
          <tr><td>③</td><td>오답</td><td>[B] 학생2는 견해를 ‘수정’하지 않는다.</td></tr>
          <tr class="correct"><td>④</td><td class="ok">정답</td><td>재진술 + 합창 동아리 정보 덧붙임.</td></tr>
          <tr><td>⑤</td><td>오답</td><td>[A] 학생3은 해결책을 제시하지 않는다.</td></tr>
        </tbody>
      </table>
    </div>
  </details>
...
<div class="q-block" id="prob6">
  ...
  <details class="solution">
    ...
    <div class="solution-body">
      <div class="question-analysis">
        <div class="answer-line"><span>정답</span><strong>⑤</strong></div>
        <p class="ask-read"><strong>발문 해석</strong> — 회의 내용 ↔ 초고를 짝지어, 빠지거나 어긋난 하나를 찾는다.</p>
        <p>(나) 5문단은 조명 밝기를 낮춰야 한다는 점과 ‘바닥 조명’ 보완 방안만 적었다. 회의에서 나온 ‘조명을 낮추면 연주가 안 보인다’는 <strong>문제점은 함께 언급되지 않았다</strong>. ⑤가 적절하지 않다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>적절</td><td>편곡 곡 + 익숙하다는 이유.</td></tr>
          <tr><td>②</td><td>적절</td><td>설문 결과(△△곡)로 제시.</td></tr>
          <tr><td>③</td><td>적절</td><td>현대시 곡 + 예상 반응(관심·추억).</td></tr>
          <tr><td>④</td><td>적절</td><td>추가 요청 + 긍정적 의미(추억).</td></tr>
          <tr class="correct"><td>⑤</td><td class="ok">부적절</td><td>보완 방안만 있고 ‘문제점’은 함께 언급 안 됨.</td></tr>
        </tbody>
      </table>
      <div class="trap">
        <div class="trap-head">조심할 점 — ‘방안’은 있고 ‘문제점’은 빠짐</div>
        <p>⑤는 ‘문제점 + 보완 방안’ 둘 다 있어야 적절하다. 초고엔 방안만 있다. 두 요소가 한 선지에 묶이면 각각 있는지 확인한다.</p>
      </div>
    </div>
  </details>
</div>
...
<div class="q-block" id="prob7">
  ...
  <ul class="q-opts">
    <li id="q7-1">① 이번 공연에서 다양한 음악 장르를 새롭게 감상할 수 있길 바라겠습니다.<a class="src-tag" href="#ev9">지문 근거</a></li>
    <li id="q7-2">② 아름다운 선율이 춤추는 국악 크로스오버 공연 부탁드립니다.<a class="src-tag" href="#ev10">지문 근거</a></li>
    <li id="q7-3">③ 국악 크로스오버는 옛것과 현대의 조화가 특징인 새 장르라고 생각합니다.<a class="src-tag" href="#ev11">지문 근거</a></li>
    <li id="q7-4">④ 이번 공연이 학업에 지친 학생들의 감성을 적시는 반가운 단비가 되기를 바랍니다.<a class="src-tag" href="#ev12">지문 근거</a></li>
    <li id="q7-5">⑤ 무지개처럼 국악에 다양한 음악이 어우러져 탄생한 국악 크로스오버 공연이 뜻깊은 축제를 만들어 줄 것이라 기대합니다.<a class="src-tag ans" href="#ev14">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        <div class="answer-line"><span>정답</span><strong>⑤</strong></div>
        <p class="ask-read"><strong>발문 해석</strong> — 〈보기〉의 <strong>세 조건</strong>(① 장르 특성 ② 공연 의의 ③ 비유)을 모두 만족하는 선지를 찾는다.</p>
        <p>⑤는 ‘국악에 다양한 음악이 어우러진’(장르 특성) + ‘뜻깊은 축제를 만들’(의의) + ‘무지개처럼’(비유)을 <strong>모두</strong> 담았다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>오답</td><td>비유·장르 특성이 없다.</td></tr>
          <tr><td>②</td><td>오답</td><td>비유는 있으나 장르 특성·의의가 약하다.</td></tr>
          <tr><td>③</td><td>오답</td><td>장르 특성은 있으나 의의·비유가 없다.</td></tr>
          <tr><td>④</td><td>오답</td><td>비유(단비)는 있으나 장르 특성이 없다.</td></tr>
          <tr class="correct"><td>⑤</td><td class="ok">정답</td><td>장르 특성+의의+비유(무지개) 모두 충족.</td></tr>
        </tbody>
      </table>
      <div class="trap">
        <div class="trap-head">조심할 점 — 조건은 ‘모두’ 충족</div>
        <p>조건형 고쳐쓰기는 <strong>조건을 체크리스트</strong>로 만들어 ○를 센다. 하나라도 빠지면 탈락 — ②④는 비유만, ③은 비유 없음.</p>
      </div>
    </div>
  </details>
</div>
...
<div class="read-guide">
  <div class="read-guide-head">이 지문, 이렇게 읽는다</div>
  <p>작문은 <strong>초고의 구조</strong>와 <strong>자료의 쓰임</strong>을 본다. 이 초고는 ‘정부·기업·소비자’ 세 주체의 노력을 <strong>병렬</strong>로 제시한다.</p>
  <ul>
    <li><strong>구조</strong> — 서론(문제 제기) → 먼저(정부: 표시 대상 확대) → 다음으로(기업: 안전성 고려) → 마지막으로(소비자: 성분 확인).</li>
  </ul>
  <p class="read-guide-tip"><strong>출제 포인트 예고</strong> — 9번은 자료(통계·기사·인터뷰)가 ‘무엇을 뒷받침하는지’ 짝이 맞는지, 특히 ‘이유’가 자료에 있는지가 함정이다.</p>
</div>
...
<div class="q-block" id="prob8">
  ...
  <ul class="q-opts">
    <li id="q8-1">① 예상되는 반론에 대한 답변을 미리 제시한다.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
    <li id="q8-2">② 속담을 활용하여 제재의 시의성을 드러낸다.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
    <li id="q8-3">③ 생소한 용어의 어원을 밝혀 이해를 돕는다.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
    <li id="q8-4">④ 담화 표지를 사용하여 내용을 구조적으로 제시한다.<a class="src-tag ans" href="#ev15">정답 근거</a></li>
    <li id="q8-5">⑤ 다른 대상과 비교하여 장단점을 밝힌다.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        <div class="answer-line"><span>정답</span><strong>④</strong></div>
        <p class="ask-read"><strong>발문 해석</strong> — 글에 실제로 ‘쓰인’ 전략을 고른다.</p>
        <p>2·3·4문단을 ‘먼저 / 다음으로 / 마지막으로’라는 <strong>담화 표지</strong>로 열어 내용을 구조적으로 제시한다. ④가 맞다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>오답</td><td>반론·답변 구조가 없다.</td></tr>
          <tr><td>②</td><td>오답</td><td>속담을 쓰지 않는다.</td></tr>
          <tr><td>③</td><td>오답</td><td>어원 풀이가 없다.</td></tr>
          <tr class="correct"><td>④</td><td class="ok">정답</td><td>‘먼저·다음으로·마지막으로’ 담화 표지로 구조화.</td></tr>
          <tr><td>⑤</td><td>오답</td><td>다른 대상과 비교하지 않는다.</td></tr>
        </tbody>
      </table>
    </div>
  </details>
...
<div class="q-block" id="prob9">
  ...
  <ul class="q-opts">
    <li id="q9-1">① ㄱ-㉮ → ‘소비 증가’의 근거로 제시.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
    <li id="q9-2">② ㄴ → ‘표시 대상 확대로 알권리 보장’ 사례로 제시.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
    <li id="q9-3">③ ㄷ → ‘직관적으로 안전성을 파악하게 돕는 방안’으로 제시.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
    <li id="q9-4">④ ㄱ-㉯+ㄴ → 소비자가 ‘성분보다 향을 중시하는 이유’로 제시.<a class="src-tag" href="#ev9">정답 근거</a></li>
    <li id="q9-5">⑤ ㄱ-㉯+ㄷ → ‘감각적 만족을 우선시한다’는 내용의 근거로 제시.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        <div class="answer-line"><span>정답</span><strong>④</strong></div>
        <p class="ask-read"><strong>발문 해석</strong> — 각 자료가 ‘무엇을’ 뒷받침하는지 짝을 맞춘다. 특히 ‘이유’를 자료가 담고 있는지 본다.</p>
        <p>ㄱ-㉯는 ‘향을 더 중시한다(72.6%)’는 <strong>사실</strong>은 보여 주지만 <strong>그 이유</strong>는 없다. ㄴ도 ‘소비자 단체의 공개 요구’일 뿐 향 중시 이유가 아니다. 따라서 ④는 적절하지 않다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>적절</td><td>시장 규모 증가 → 소비 증가 근거.</td></tr>
          <tr><td>②</td><td>적절</td><td>해외 표시 확대 → 알권리 보장 사례.</td></tr>
          <tr><td>③</td><td>적절</td><td>등급제 → 직관적 파악 방안.</td></tr>
          <tr class="correct"><td>④</td><td class="ok">부적절</td><td>‘향 중시’는 보이나 그 ‘이유’는 자료에 없다.</td></tr>
          <tr><td>⑤</td><td>적절</td><td>향 우선 경향 → 감각적 만족 우선의 근거.</td></tr>
        </tbody>
      </table>
      <div class="trap">
        <div class="trap-head">조심할 점 — ‘사실’ vs ‘이유’</div>
        <p>자료는 ‘향을 더 고른다’는 결과를 보여 줄 뿐, ‘왜 그러는지’는 없다. ④는 결과를 ‘이유’로 둔갑시켰다. 자료가 답하는 질문이 무엇인지 확인한다.</p>
      </div>
    </div>
  </details>
</div>
...
<div class="q-block" id="prob10">
  ...
  <ul class="q-opts">
    <li id="q10-1">① 활용 분야를 언급한 뒤, ‘연구를 위한 기업의 노력’을 제시하자.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
    <li id="q10-2">② 사회적 인식을 언급한 뒤, ‘세 주체가 협력해야 하는 이유’를 제시하자.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
    <li id="q10-3">③ 꼭 필요한 이유를 언급한 뒤, ‘기업의 책임’을 제시하자.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
    <li id="q10-4">④ 효용성을 언급한 뒤, 안전한 사용을 위해 ‘여러 주체의 노력’이 필요함을 제시하자.<a class="src-tag" href="#ev10">정답 근거</a></li>
    <li id="q10-5">⑤ 우려되는 점을 언급한 뒤, ‘기업·정부·소비자의 상호작용’이 필요함을 제시하자.<a class="src-tag ans" href="#ev15">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        <div class="answer-line"><span>정답</span><strong>④</strong></div>
        <p class="ask-read"><strong>발문 해석</strong> — 작성된 결론을 분해해, 무엇을 ‘언급한 뒤’ 무엇을 ‘제시’했는지로 조언을 역추적한다.</p>
        <p>결론은 ‘유용한 성분(효용성)’을 먼저 말하고, ‘정부·기업·소비자 모두(여러 주체)의 노력’을 제시한다. ④가 그 구성과 일치한다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
          <tr><td>①</td><td>오답</td><td>‘기업만’이 아니라 세 주체다.</td></tr>
          <tr><td>②</td><td>오답</td><td>‘협력 이유’가 아니라 ‘노력 필요’를 제시한다.</td></tr>
          <tr><td>③</td><td>오답</td><td>‘기업 책임’만이 아니다.</td></tr>
          <tr class="correct"><td>④</td><td class="ok">정답</td><td>효용성 언급 + 여러 주체의 노력 제시.</td></tr>
          <tr><td>⑤</td><td>오답</td><td>도입이 ‘우려’가 아니라 ‘효용성’이다.</td></tr>
        </tbody>
      </table>
      <div class="trap">
...
<div class="passage">
  ...
  <p>두 단어의 관계는 의미 성분을 분석해 비교할 수 있다. <span class="ev ans" id="ev16">의미 성분 분석이란 단어의 의미를 더 작은 의미 단위인 의미 성분으로 분해하여 표시하는 방법으로, 각 단어가 해당 성분을 포함하는지 여부를 [+], [-] 기호로 표시한다.</span><a class="ev-tag ans" href="#q11-1">11-①</a> ‘동물’은 [+생명체][+움직임], ‘새’는 [+생명체][+움직임][+날개]로 분석된다. <span class="ev" id="ev17">하위어는 상위어의 의미 성분을 모두 포함하면서 다른 의미 성분을 추가로 지니므로, 상위어보다 의미 성분의 수가 많고 지시 대상의 범위가 좁으며 의미가 더 구체적이다.</span><a class="ev-tag" href="#q12-1">12-①</a><a class="ev-tag" href="#q12-2">12-②</a> ‘새’와 ‘물고기’처럼 <span class="ev" id="ev18">동일한 상위어(‘동물’)를 공유하는 같은 층위의 단어를 공하위어라 한다.</span><a class="ev-tag" href="#q11-3">11-③</a></p>
...
<div class="q-block" id="prob11">
  ...
  <ul class="q-opts">
    ...
    <li id="q11-2">② 두 단어가 서로 공유하는 의미 성분이 없을 경우에도 상하 관계가 성립할 수 있다.<a class="src-tag" href="#ev17">지문 근거</a></li>
    <li id="q11-3">③ 상하 관계에서 동일한 하위어를 공유하는 단어를 공하위어라고 한다.<a class="src-tag" href="#ev18">지문 근거</a></li>
    <li id="q11-4">④ 상위어의 의미 성분은 [+]로, 하위어의 의미 성분은 [-]로 표시한다.<a class="src-tag" href="#ev18">지문 근거</a></li>
    <li id="q11-5">⑤ 하위어란 의미상 다른 단어를 포함하는 단어를 말한다.<a class="src-tag" href="#ev17">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob12">
  <p class="q-stem">12. 윗글을 바탕으로 〈보기〉를 이해한 내용으로 적절하지 <strong>않은</strong> 것은? <span class="q-pt-inline">[3점]</span> <span class="q-rate">오답률 51.5%</span></p>
  <div class="q-bogi">
    <p class="bogi-label">&lt; 보 기 &gt;</p>
  ...
  <ul class="q-opts">
    ...
    <li id="q12-3">③ ㉡: ‘손가락’과 ‘손’ 사이에는 ‘A는 B의 일종이다’라는 관계가 성립하지 않는다.<a class="src-tag ans" href="#ev19">지문 근거</a></li>
...
<div class="q-block" id="prob13">
  <p class="q-stem">13. 〈학습 활동〉을 수행한 결과로 적절하지 <strong>않은</strong> 것은? <span class="q-rate">오답률 63.3%</span></p>
  <div class="q-bogi">
  ...
  <ul class="q-opts">
    <li id="q13-1">① (㉠·ⓐ) 할머니는 언제나 <u>내가 건강하기</u>만 <u>바라는</u> 분이시다.<a class="src-tag ans" href="#ev16">지문 근거</a></li>
    ...
    <li id="q13-4">④ (㉡·ⓑ) 의사는 보호자에게 <u>환자를 어서 눕히라고</u> 말했다.<a class="src-tag ans" href="#ev19">지문 근거</a></li>
...
<div class="q-block" id="prob14">
  <p class="q-stem">14. 〈보기〉 선생님의 설명을 바탕으로 ‘ㅎ’의 음운 변동을 탐구한 내용으로 적절하지 <strong>않은</strong> 것은? <span class="q-rate">오답률 81.0%</span></p>
  <div class="q-bogi">
    <p class="bogi-label">&lt; 보 기 &gt;</p>
  ...
  <ul class="q-opts">
    ...
    <li id="q14-2">② ‘놓고’: ‘ㅎ’이 뒤의 ‘ㄱ’을 만나 거센소리로 축약된다.<a class="src-tag ans" href="#ev16">지문 근거</a></li>
    ...
    <li id="q14-5">⑤ ‘쌓네’: ‘ㅎ’이 음절의 끝소리 규칙으로 ‘ㄷ’이 된 뒤, ‘ㄷ’이 ‘ㄴ’을 만나 비음으로 교체된다.<a class="src-tag ans" href="#ev19">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob15">
  ...
  <ul class="q-opts">
    <li id="q15-1">① 잇녀 / 그러터녀 / 求ᄒ다<a class="src-tag ans" href="#ev16">지문 근거</a></li>
    <li id="q15-2">② 잇녀 / 그러터뇨 / 求ᄒ뇨<a class="src-tag ans" href="#ev16">지문 근거</a></li>
    <li id="q15-3">③ 잇뇨 / 그러터녀 / 求ᄒ다<a class="src-tag ans" href="#ev15">정답 근거</a></li>
    <li id="q15-4">④ 잇뇨 / 그러터녀 / 求ᄒ뇨<a class="src-tag ans" href="#ev19">지문 근거</a></li>
    <li id="q15-5">⑤ 잇뇨 / 그러터뇨 / 求ᄒ뇨<a class="src-tag ans" href="#ev16">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  ...
  <p>데카르트는 <span class="ev" id="ev-q17-1">선입견과 이성이 인간의 앎을 지배하려 끝없이 경쟁한다</span><a class="ev-tag" href="#q17-1">17-㉮</a>고 보았다. <span class="ev ans" id="ev22">우리는 스스로 감각한 것을 그대로 신뢰하는 성향이 있어 감각한 현상을 곧 실재라 여기지만, 데카르트는 이를 선입견으로 비판했다. 하나의 감각으로부터의 판단을 교정하는 것은 다른 감각이 아니라 오직 이성이다.</span><a class="ev-tag ans" href="#q17-3">17-㉰</a></p>
  <p>데카르트의 관점에서 <span class="ev" id="ev-q17-2">우리의 판단은 이미 형성된 의견에 종속돼 오류가 생기기 쉽다.</span><a class="ev-tag" href="#q17-2">17-㉯</a> 그래서 그는 의심 가능한 모든 것을 의심하는 방법적 회의로 선입견을 제거해 ‘사유하는 자아’만 남겨야 한다고 했다. <span class="ev" id="ev24">사유하는 자아가 되면 이성을 규준으로 끊임없이 자신을 성찰하는 자기 인식을 할 수 있는데, 데카르트는 이를 교육의 목적으로 보았다.</span><a class="ev-tag" href="#q19-5">19-⑤</a> 교사의 역할은 지식을 일방적으로 전달하는 것이 아니라 학습자가 자기 인식을 하도록 돕는 데 있다.</p>
  ...
  <p>선입견은 인간 존재가 겪어 온 시간 속에서 형성되므로 현재의 이해는 유한한 역사를 바탕으로 한다. <span class="ev" id="ev26">하이데거는 인간 존재를 ‘바로 지금 그곳에 있는 존재’라는 뜻의 ‘현존재’라 부르며, 인간은 늘 특정 역사·사회·관계 등 자신의 삶의 이력을 바탕으로 존재한다.</span><a class="ev-tag" href="#q17-5">17-㉲</a> <span class="ev ans" id="ev27">㉠이러한 관점에서 매 순간의 이해는 과거의 시간성에 기인한다.</span><a class="ev-tag ans" href="#q18-4">18-④</a></p>
  <p><span class="ev" id="ev-q20-3">인간 존재는 선입견을 바탕으로 세계를 해석하고, 그로써 선입견을 발전시키며 다시 해석하는 해석의 순환을 겪는다</span><a class="ev-tag" href="#q20-3">20-③</a>(ⓔ<u>겪는다</u>). 따라서 이해는 하나의 고정된 의미로 완결될 수 없다. <span class="ev ans" id="ev28">이런 측면에서 하이데거는 객관적 사실로 여겨지는 과학적 언술도 완결되지 않은 조건부 진리이며, 객관적 세계를 나타내는 것이 아니라 지금 눈앞에 있는 모습을 서술하는 것뿐이라고 보았다.</span><a class="ev-tag ans" href="#q20-5">20-⑤</a></p>
...
<div class="q-block" id="prob16">
  ...
  <ul class="q-opts">
    <li id="q16-1">① (가)와 (나) 모두 선입견에 대한 철학자의 주장을 소개하고 그 한계점을 지적한다.<a class="src-tag ans" href="#ev22">지문 근거</a></li>
    ...
    <li id="q16-4">④ (가)는 (나)와 달리 철학자가 제시한 사례를 유형화해 비교한다.<a class="src-tag ans" href="#ev22">지문 근거</a></li>
...
<div class="q-block" id="prob18">
  ...
  <ul class="q-opts">
    <li id="q18-1">① 인간 존재의 유한한 역사는 이해의 작용에 제약이 된다.<a class="src-tag ans" href="#ev27">지문 근거</a></li>
    <li id="q18-2">② 인간 존재는 이해를 위해 특정 역사·사회·관계를 배제해야 한다.<a class="src-tag ans" href="#ev22">지문 근거</a></li>
    <li id="q18-3">③ 이해되는 세계는 삶의 포괄적 환경이 아니라 특정 사회적 맥락이다.<a class="src-tag" href="#ev24">지문 근거</a></li>
    <li id="q18-4">④ 이해에 바탕이 되는 선입견은 인간 존재가 겪어 온 삶의 이력으로 형성된다.<a class="src-tag ans" href="#ev27">정답 근거</a></li>
    <li id="q18-5">⑤ 이해 작용은 과거에서 시작되므로 현재의 이해는 하나의 고정된 의미로 완결된다.<a class="src-tag" href="#ev26">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob19">
  ...
  <ul class="q-opts">
    <li id="q19-1">① 데카르트는 교육으로 사유하는 자아에서 벗어나야 한다고, 하이데거는 조건부 진리에서 벗어나야 한다고 보았다.<a class="src-tag" href="#ev21">지문 근거</a></li>
    <li id="q19-2">② 데카르트는 교육이 전통·습관대로 이루어져야 한다고, 하이데거는 이성적 능력을 도야해야 한다고 보았다.<a class="src-tag ans" href="#ev22">지문 근거</a></li>
    ...
    <li id="q19-5">⑤ 데카르트는 교육의 목적이 자기 성찰에 있다고, 하이데거는 학습자가 세계와 분리되지 않은 채 사유하는 것이 중요하다고 보았다.<a class="src-tag" href="#ev24">근거 A</a><a class="src-tag ans" href="#ev29" id="q19-5b">근거 B</a><a class="src-tag ans" href="#ev19">정답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob20">
  <p class="q-stem">20. 〈보기〉(학습 일지)를 데카르트(A)·하이데거(B)의 관점에서 설명한 내용으로 적절하지 <strong>않은</strong> 것은? <span class="q-pt-inline">[3점]</span> <span class="q-rate">오답률 35.4%</span></p>
  <div class="q-bogi">
    <p class="bogi-label">&lt; 보 기 &gt;</p>
  ...
  <ul class="q-opts">
    ...
    <li id="q20-2">② A 관점: 막대가 원래 꺾였다고 생각한 것은 감각을 그대로 신뢰하는 성향에 의한 것이다.<a class="src-tag ans" href="#ev22">지문 근거</a></li>
...
<div class="q-block" id="prob21">
  ...
  <ul class="q-opts">
    <li id="q21-1">① ⓐ(내리기): 올해는 유난히 눈이 많이 <u>내렸다</u>.<a class="src-tag" href="#ev21">지문 근거</a></li>
    <li id="q21-2">② ⓑ(말하며): 나는 동생에게 그 사실을 <u>말하러</u> 갔다.<a class="src-tag ans" href="#ev22">지문 근거</a></li>
    <li id="q21-3">③ ⓒ(삼아): 그는 이번 일을 성장의 계기로 <u>삼았다</u>.<a class="src-tag" href="#ev21">정답 근거</a></li>
    <li id="q21-4">④ ⓓ(가지고): 나는 밀가루를 <u>가지고</u> 빵을 만들었다.<a class="src-tag ans" href="#ev28">지문 근거</a></li>
    <li id="q21-5">⑤ ⓔ(겪는다): 그는 며칠 동안 손님을 <u>겪느라</u> 고단했다.<a class="src-tag ans" href="#ev28">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  ...
  <p>공간분해능과 시간분해능은 서로 관련된다. <span class="ev ans" id="ev30">일반적으로 수평 공간분해능을 대기의 최대 속도로 나눈 값을 시간분해능의 상한선으로 둔다. 대기가 정해진 시간 간격 동안 격자점 간 거리보다 더 멀리 이동하면 변수의 값을 구할 수 없는 격자점이 생기기 때문이다.</span><a class="ev-tag ans" href="#q22-5">22-⑤</a> 또 <span class="ev ans" id="ev34">수평 공간분해능을 두 배로 높이면 계산 안정성을 위해 연직 공간분해능·시간분해능도 각각 두 배로 높여, 세 공간축과 시간축에서 계산량이 각각 두 배씩 늘어 전체 계산량은 2⁴(=16)배가 된다.</span><a class="ev-tag ans" href="#q25-4">25-④</a></p>
  <p>세분화 뒤에는 계산 조건을 설정한다. <span class="ev ans" id="ev31">시간에 대한 초기 조건은 모의 시작 시점의 대기 상태로, 격자점마다 변수의 값을 개별적으로 부여한다.</span><a class="ev-tag ans" href="#q23-5">23-⑤</a> 공간에 대한 경계 조건은 하단·상단·측면에서의 대기 상태 설정이다. <span class="ev" id="ev32">하단 경계에서는 대기가 지표면을 통과할 수 없어 연직 운동이 없다고 가정</span><a class="ev-tag" href="#q24-1">24-①</a>하되, 지표면이 흡수한 태양 에너지가 열·수증기로 대기에 전달되는 에너지 흐름을 반영해 계산한다.</p>
  <p>상단 경계에서는 고도가 높을수록 연직 운동이 약해지므로 <span class="ev" id="ev33">최상층에서 연직 운동이 없다고 가정해 연직 속도를 0으로 설정한다.</span><a class="ev-tag" href="#q24-1b">24-①</a> 그러면 빠져나가야 할 에너지가 최상층에서 반사·되돌아와 영역 내부 에너지가 비현실적으로 증가해 변수 값이 왜곡될 수 있다. 이를 완화하려 영역 내부에 감쇠층을 두는 방법과 에너지가 자연히 흩어지게 하는 방법을 함께 쓴다(최상층 고도 약 80km 이상이면 후자, 그보다 낮으면 전자가 주요).</p>
...
<div class="q-block" id="prob22">
  ...
  <ul class="q-opts">
    <li id="q22-1">① 대기의 상태는 기압, 기온, 습도, 바람 등의 변수로 나타낸다.<a class="src-tag ans" href="#ev30">지문 근거</a></li>
    <li id="q22-2">② 시간 간격이 좁을수록 대기 상태의 변화 양상을 연속적으로 모의할 수 있다.<a class="src-tag ans" href="#ev31">지문 근거</a></li>
    <li id="q22-3">③ 모의하는 영역의 대기는 육면체 공기 덩이들의 집합체가 된다.<a class="src-tag ans" href="#ev30">지문 근거</a></li>
...
<div class="q-block" id="prob23">
  ...
  <ul class="q-opts">
    <li id="q23-1">① ㉠: 대기의 운동·변화를 설명하는 방정식들을 슈퍼컴퓨터로 계산한다.<a class="src-tag ans" href="#ev31">지문 근거</a></li>
    <li id="q23-2">② ㉡: 방정식들의 근사해를 구해 미래 대기 상태를 도출하는 것이다.<a class="src-tag" href="#ev32">지문 근거</a></li>
    <li id="q23-3">③ ㉢: 모델의 가동 목적에 따라 모의할 대기 영역을 정한다.<a class="src-tag ans" href="#ev31">지문 근거</a></li>
...
<div class="q-block" id="prob24">
  ...
  <ul class="q-opts">
    <li id="q24-1">① 하단 경계에서는 상단 경계에서와 마찬가지로 대기의 연직 운동이 없다고 가정한다.<a class="src-tag" href="#ev32">근거(하단)</a><a class="src-tag ans" href="#ev33" id="q24-1b">근거(상단)</a><a class="src-tag" href="#ev24">정답 근거</a></li>
    ...
    <li id="q24-4">④ 상단 경계에서는 하단 경계와 마찬가지로 변수 값이 왜곡돼 에너지가 비현실적으로 증가한다고 가정한다.<a class="src-tag ans" href="#ev30">지문 근거</a></li>
    <li id="q24-5">⑤ 측면 경계에서는 상단 경계와 달리 반사된 에너지가 영역 내부로 되돌아온다고 가정한다.<a class="src-tag ans" href="#ev34">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob25">
  <p class="q-stem">25. 윗글을 참고하여 〈보기〉를 이해한 반응으로 적절하지 <strong>않은</strong> 것은? <span class="q-pt-inline">[3점]</span> <span class="q-rate">오답률 59.2%</span></p>
  <div class="q-bogi">
    <p class="bogi-label">&lt; 보 기 &gt;</p>
  ...
  <ul class="q-opts">
    <li id="q25-1">① A는 C보다 수평·연직 해상도가 높아 더 세밀하게 모의할 수 있다.<a class="src-tag ans" href="#ev30">지문 근거</a></li>
    <li id="q25-2">② 최대 속도가 2배가 되면, D는 B와 달리 시간분해능을 다시 설정하지 않아도 된다.<a class="src-tag ans" href="#ev31">지문 근거</a></li>
    ...
    <li id="q25-5">⑤ B·D는 상위 모델과의 불일치를 줄이려 A나 C에게서 받은 자료를 측면 경계 조건으로 쓴다.<a class="src-tag ans" href="#ev34">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  ...
  <p>죄의 수가 하나면 일죄, 여럿이면 수죄다. 일죄의 전형은 하나의 행위가 하나의 구성요건에 해당하는 경우다. <span class="ev" id="ev39">이 외에 여러 구성요건에 해당하는 듯 보여도 구성요건 사이의 논리적 관계로 하나만 적용되는 경우를 ‘법조경합’이라 하며, 하나의 법조문만 적용해도 불법의 크기를 책임 정도에 따라 적정하게 평가할 수 있다고 본다.</span><a class="ev-tag" href="#q29-2">29-②</a><a class="ev-tag" href="#q29-3">29-③</a> 예컨대 허위 매매계약서를 작성하며 남의 도장까지 위조하면 사문서위조죄·인장위조죄에 모두 해당하는 듯하나, 문서 위조를 위해 인장을 위조한 것이므로 이중 평가를 피해 사문서위조죄만 성립한다.</p>
  <p>수죄에는 <span class="ev ans" id="ev38">하나의 행위로 여러 죄가 성립하는 상상적 경합과 여러 행위로 여러 죄가 성립하는 실체적 경합이 있다.</span><a class="ev-tag ans" href="#q29-5">29-⑤</a> 한 개의 돌을 던져 사람을 다치게 하고 유리창을 깨 상해죄·손괴죄가 성립하면 상상적 경합이다. 형법 제40조는 상상적 경합을 가장 무거운 죄(법정형이 가장 무거운 죄)에 정한 형으로 처벌한다고 규정한다.</p>
  <div class="seg" id="segA">
    <p class="seg-label">[A]</p>
    <p>실체적 경합은 수죄의 가장 전형적 경우로, 그 관계의 여러 죄를 경합범이라 한다. <span class="ev ans" id="ev37">경합범의 형을 선고할 때 각각의 형을 단순 합산하지 않고 별도의 처벌 원칙을 둔다.</span><a class="ev-tag ans" href="#q28-1">28-①</a> 단순 합산하면 예방 효과가 중복돼 책임 한도를 넘는 처벌이 될 수 있기 때문이다. 그중 기본이 가중주의로, 가장 무거운 죄를 기준 삼아 일정 부분을 가중해 형을 산정한다. 다만 이를 적용하려면 여러 죄가 동일 재판에서 판결될 가능성이 있어야 한다. 그렇지 않으면 각 죄가 개별 재판에서 판결돼 별도의 처벌 원칙을 적용하지 못한다.</p>
  </div>
</div>
...
<div class="q-block" id="prob26">
  ...
  <ul class="q-opts">
    <li id="q26-1">① 일죄의 개념<a class="src-tag ans" href="#ev35">지문 근거</a></li>
    <li id="q26-2">② 형법의 정의<a class="src-tag ans" href="#ev35">지문 근거</a></li>
    <li id="q26-3">③ 법조경합의 종류<a class="src-tag" href="#ev26">정답 근거</a></li>
    <li id="q26-4">④ 책임주의의 의미<a class="src-tag" href="#ev39">지문 근거</a></li>
    <li id="q26-5">⑤ 상상적 경합의 사례<a class="src-tag ans" href="#ev38">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob27">
  ...
  <ul class="q-opts">
    ...
    <li id="q27-2">② ㉡<a class="src-tag ans" href="#ev35">지문 근거</a></li>
    <li id="q27-3">③ ㉢<a class="src-tag" href="#ev39">지문 근거</a></li>
    <li id="q27-4">④ ㉣<a class="src-tag ans" href="#ev38">지문 근거</a></li>
    <li id="q27-5">⑤ ㉤<a class="src-tag ans" href="#ev38">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob28">
  ...
  <ul class="q-opts">
    ...
    <li id="q28-2">② 경합범에 대해 형법은 예방 효과 중복을 고려해 별도의 처벌 원칙을 둔다.<a class="src-tag ans" href="#ev37">지문 근거</a></li>
    <li id="q28-3">③ 동일 재판에서 판결될 가능성이 있어야 별도의 처벌 원칙을 적용한다.<a class="src-tag ans" href="#ev37">지문 근거</a></li>
    <li id="q28-4">④ 실체적 경합은 한 사람의 여러 행위로 여러 죄가 성립하는 것이다.<a class="src-tag ans" href="#ev38">지문 근거</a></li>
    <li id="q28-5">⑤ 경합범은 실체적 경합 관계의 여러 죄를 가리킨다.<a class="src-tag ans" href="#ev38">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob29">
  <p class="q-stem">29. 윗글을 참고할 때 〈보기〉에 대한 반응으로 적절하지 <strong>않은</strong> 것은? <span class="q-pt-inline">[3점]</span> <span class="q-rate">오답률 46.9%</span></p>
  <div class="q-bogi">
    <p class="bogi-label">&lt; 보 기 &gt;</p>
  ...
  <ul class="q-opts">
    <li id="q29-1">① (가)에서 검사는 A 씨가 여러 구성요건에 해당하는 행위를 했다고 보고 두 죄로 기소한 것이다.<a class="src-tag ans" href="#ev38">지문 근거</a></li>
    ...
    <li id="q29-4">④ (나)에서 법원은 B 씨의 범죄가 수죄라고 보고 법정형이 가장 무거운 죄에 정한 형으로 처벌한 것이다.<a class="src-tag ans" href="#ev38">지문 근거</a></li>
...
<div class="q-block" id="prob30">
  ...
  <ul class="q-opts">
    ...
    <li id="q30-2">② 선행은 또 다른 선행을 <u>부른다</u>.<a class="src-tag ans" href="#ev37">지문 근거</a></li>
    <li id="q30-3">③ 나는 집 앞으로 택시를 <u>불렀다</u>.<a class="src-tag ans" href="#ev38">지문 근거</a></li>
    <li id="q30-4">④ 그 가게에서는 값을 싸게 <u>부른다</u>.<a class="src-tag" href="#ev39">지문 근거</a></li>
    <li id="q30-5">⑤ 나는 멀리 있는 친구를 손짓하여 <u>불렀다</u>.<a class="src-tag ans" href="#ev35">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  ...
  <p>조수아가 노발대발하며 베개를 베고 누우니 관은 벗겨지고 비녀는 빠져 있었다. 강왕이 한참 살펴보다 말하였다. “㉢<span class="ev ans" id="ev-q32-3">과인이 죽지 않았는데, 채운루에 박복한 청상 홀어미 모습이 어찌된 일이오? 자세히 곡절을 알고자 하오.</span><a class="ev-tag ans" href="#q32-3">32-③</a>”</p>
  ...
  <p>계파는 조수아를 젖 먹여 키운 정이 깊어 그 신세를 생각하니 <span class="ev ans" id="ev40">우울하였으나 어찌할 계교가 없었다. 계파는 본래 성품이 모가 나지 않았기에 위옥희를 해칠 마음을 내거나 하지는 않았다.</span><a class="ev-tag ans" href="#q33-5">33-ⓔ</a></p>
  <p>이날 밤 강왕이 남궁에서 위옥희를 대하니 자태가 더욱 새로웠다. 왕이 흔연히 웃으며 말하였다. “㉤과인이 과연 처복이 넘치오. 하늘에서 성녀를 점지하였으니 시경의 노래가 조금도 부럽지 않소. 또한 조씨같이 아름다운 여인이 그 뒤를 이었으니, <span class="ev ans" id="ev-q34-5">그대가 태임·태사의 덕을 이어 과인에게 내조를 잘 하시도록 하오.</span><a class="ev-tag ans" href="#q34-5">34-⑤</a>”</p>
...
<div class="q-block" id="prob31">
  ...
  <ul class="q-opts">
    <li id="q31-1">① 인물의 행동을 과장되게 표현하여 인물을 희화화하고 있다.<a class="src-tag ans" href="#ev40">지문 근거</a></li>
    <li id="q31-2">② 편집자적 논평을 활용하여 서술자의 생각을 드러내고 있다.<a class="src-tag ans" href="#ev40">정답 근거</a></li>
    <li id="q31-3">③ 독백을 반복하여 내적 갈등의 해결 과정을 보여 주고 있다.<a class="src-tag ans" href="#ev40">지문 근거</a></li>
    <li id="q31-4">④ 꿈과 현실을 교차하여 사건을 입체적으로 구성하고 있다.<a class="src-tag ans" href="#ev40">지문 근거</a></li>
    <li id="q31-5">⑤ 공간적 배경을 묘사하여 긴박한 분위기를 드러내고 있다.<a class="src-tag ans" href="#ev40">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob32">
  ...
  <ul class="q-opts">
    <li id="q32-1">① ㉠: 자신과 다른 인물의 차이점을 언급하며 앞으로의 일을 예견한다.<a class="src-tag ans" href="#ev-q32-3">지문 근거</a></li>
    <li id="q32-2">② ㉡: 사건의 인과 관계를 바탕으로 상대의 의도에 의문을 제기한다.<a class="src-tag ans" href="#ev-q32-3">지문 근거</a></li>
    <li id="q32-3">③ ㉢: 상대의 외양에 대한 생각을 드러내며 상대에게 설명을 요구한다.<a class="src-tag ans" href="#ev-q32-3">정답 근거</a></li>
    <li id="q32-4">④ ㉣: 미래의 상황을 가정하며 상대의 어려움에 공감한다.<a class="src-tag ans" href="#ev-q34-5">지문 근거</a></li>
    <li id="q32-5">⑤ ㉤: 다른 사람의 말을 근거로 삼아 자신의 행동 변화를 약속한다.<a class="src-tag ans" href="#ev40">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob33">
  ...
  <ul class="q-opts">
    <li id="q33-1">① ⓐ<a class="src-tag ans" href="#ev40">지문 근거</a></li>
    <li id="q33-2">② ⓑ<a class="src-tag ans" href="#ev40">지문 근거</a></li>
    <li id="q33-3">③ ⓒ<a class="src-tag ans" href="#ev40">지문 근거</a></li>
    <li id="q33-4">④ ⓓ<a class="src-tag ans" href="#ev40">지문 근거</a></li>
...
<div class="q-block" id="prob34">
  ...
  <ul class="q-opts">
    <li id="q34-1">① 곽후가 남편과 함께 겪은 어려움과 이후 버림받은 일을 밝히는 데서 원통함의 원인이 드러난다.<a class="src-tag ans" href="#ev-q34-5">지문 근거</a></li>
    <li id="q34-2">② 곽후가 음양을 바꿔 달라 비는 데서 남편과 반대 성별로 태어나려는 이유가 드러난다.<a class="src-tag ans" href="#ev40">지문 근거</a></li>
    <li id="q34-3">③ 옥황상제가 세 사람의 윤회를 관장하는 데서 초월적 존재가 부탁을 수용함이 드러난다.<a class="src-tag ans" href="#ev-q32-3">지문 근거</a></li>
    <li id="q34-4">④ 조수아가 스스로 박명하다며 분함을 토로하는 데서 전생의 남편이 환생 후 고통받는 역전이 드러난다.<a class="src-tag ans" href="#ev-q34-5">지문 근거</a></li>
...
<div class="passage">
  ...
  <p>홍보실 직원이래야 김 실장, 사진 기자 미스터 윤, 타자수 미스 홍, 그리고 그가 전부였다. 우두머리 김 실장이 <span class="ev ans" id="ev-q37-a">ⓐ<u>실눈을 뜨기 시작하면 일은 이미 그른 거나 다름없었다.</u></span><a class="ev-tag ans" href="#q37-1">37-ⓐ</a> 그의 실눈은 뱀처럼 찬 냉기를 담고 있어 마주 보기가 섬뜩하였다.</p>
  ...
  <p>“상무님 퇴근 전에 원고 올려봐요.” “네, 그런데…….” “아직 다 못 썼나요?” “㉢몇 장까지 나갔어요?” 모든 것을 알면서도 김 실장은 끈덕지게 캐물었다. <span class="ev ans" id="ev42">그는 틀림없이 동년배이거나 후배일 김 실장의 질책에 전전긍긍하면서 당황하기 시작한다.</span><a class="ev-tag ans" href="#q35-1">35-①</a></p>
  ...
  <p>대문에 들어서며 짓는 미소며 <span class="ev ans" id="ev-q37-b">ⓑ<u>헛기침</u></span><a class="ev-tag ans" href="#q37-1">37-ⓑ</a>은 가당찮은 억지였다. 그러나 그는 어떻게 해야 이 소왕국의 평화가 유지되는지 알았다. <span class="ev ans" id="ev45">밖에서야 어쨌든 집 안에서의 그는 칠백만 불의 사나이거나 슈퍼맨이거나 무적의 검객에 세도가여야 했다.</span><a class="ev-tag ans" href="#q38-2">38-②</a> 실현은 힘들어도 흉내쯤은 쉬웠으므로 그는 아까의 긴 한숨을 잊기로 한다.</p>
  <p class="muted">(중략)</p>
  <p>“문을 열어놨는데도 안 나간 것 같아요. 저게 우리를 골탕 먹이려 작정했나봐요.” 아무도 그에게 휴식을 주려 하지 않았다. 아이들은 복수전을 종용하고, 아내는 쥐의 횡포를 호소하며 그의 전의를 부채질했다. <span class="ev ans" id="ev43">그런데도 그가 없는 낮 동안 탈출을 시도하지 않은 쥐를 생각하면, 솟아오르던 전의가 슬쩍 사라지는 기분이었다.</span><a class="ev-tag ans" href="#q36-5">36-⑤</a></p>
...
<div class="q-block" id="prob35">
  ...
  <ul class="q-opts">
    ...
    <li id="q35-2">② 장면의 빈번한 전환으로 인물 간의 긴장감을 고조시킨다.<a class="src-tag ans" href="#ev42">지문 근거</a></li>
    <li id="q35-3">③ 시대적 배경을 제시해 사건의 원인을 구체적으로 보여 준다.<a class="src-tag ans" href="#ev42">지문 근거</a></li>
    <li id="q35-4">④ 외부 이야기에 내부 이야기를 삽입해 해결의 실마리를 드러낸다.<a class="src-tag ans" href="#ev45">지문 근거</a></li>
    <li id="q35-5">⑤ 다른 장소에서 동시에 일어난 사건을 제시해 상황을 대비한다.<a class="src-tag ans" href="#ev42">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob36">
  ...
  <ul class="q-opts">
    <li id="q36-1">① ㉠: 자신이 직면한 문제의 원인을 다른 대상에 돌리는 모습이 나타난다.<a class="src-tag ans" href="#ev42">지문 근거</a></li>
    <li id="q36-2">② ㉡: 상대가 부른 호칭으로 인해 느끼는 불편한 감정이 담겨 있다.<a class="src-tag ans" href="#ev43">지문 근거</a></li>
    <li id="q36-3">③ ㉢: 제대로 답하지 못하는 상대를 질책하는 모습이 나타난다.<a class="src-tag ans" href="#ev43">지문 근거</a></li>
    <li id="q36-4">④ ㉣: 상대의 태도가 급작스럽게 달라진 것에 대한 반응이 나타난다.<a class="src-tag ans" href="#ev43">지문 근거</a></li>
...
<div class="q-block" id="prob37">
  ...
  <ul class="q-opts">
    <li id="q37-1">① ⓐ는 ‘그’가 앞으로 벌어질 일을 짐작하는 단서이고, ⓑ는 자신이 겪은 일에서 느낀 심정을 감추려는 행동이다.<a class="src-tag ans" href="#ev-q37-a">ⓐ 근거</a><a class="src-tag ans" href="#ev-q37-b">ⓑ 근거</a></li>
    <li id="q37-2">② ⓐ는 ‘김 실장’을 오해하는 계기이고, ⓑ는 품은 의혹을 해소하려는 행동이다.<a class="src-tag ans" href="#ev-q37-a">지문 근거</a></li>
    <li id="q37-3">③ ⓐ는 삶의 활력을 얻는 계기이고, ⓑ는 자신을 위로하려는 행동이다.<a class="src-tag ans" href="#ev-q37-b">지문 근거</a></li>
    <li id="q37-4">④ ⓐ는 ‘김 실장’의 허점을 발견하는 단서이고, ⓑ는 실수를 숨기려는 행동이다.<a class="src-tag ans" href="#ev-q37-a">지문 근거</a></li>
    <li id="q37-5">⑤ ⓐ는 안도감을 느끼는 계기이고, ⓑ는 권위를 내세우려는 행동이다.<a class="src-tag ans" href="#ev-q37-b">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        ...
        <p>ⓐ실눈은 ‘뜨기 시작하면 일은 이미 그른 거나 다름없’어 <strong>앞일을 짐작하는 단서</strong>이고, ⓑ헛기침은 회사에서 당한 일의 심정을 감추는 ‘가당찮은 억지’ 행동이다. 따라서 ①.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
...
<div class="q-block" id="prob38">
  <p class="q-stem">38. 〈보기〉를 바탕으로 윗글을 감상한 내용으로 적절하지 <strong>않은</strong> 것은? <span class="q-pt-inline">[3점]</span> <span class="q-rate">오답률 31.2%</span></p>
  <div class="q-bogi">
    <p class="bogi-label">&lt; 보 기 &gt;</p>
  ...
  <ul class="q-opts">
    <li id="q38-1">① ‘빈 원고 용지’에 ‘37, 36, 35’를 써보는 데서, 부정적 시선에도 소극적으로 대응함을 알 수 있다.<a class="src-tag ans" href="#ev45">지문 근거</a></li>
    <li id="q38-2">② ‘어설픈 흉내’를 내며 ‘긴 한숨을 잊기로’ 하는 데서, 괴리로 인해 가족의 기대에서 벗어나려는 심리를 알 수 있다.<a class="src-tag ans" href="#ev45">정답 근거</a></li>
    <li id="q38-3">③ ‘구석구석 노려보’며 ‘허공과 마주 서서 대항’하는 데서, 인물의 무력함을 알 수 있다.<a class="src-tag ans" href="#ev42">지문 근거</a></li>
    <li id="q38-4">④ ‘덫에 걸릴 것’을 생각하다 ‘김 실장 앞에’ 서 있던 자신을 떠올리는 데서, 자신을 쥐에 투영함을 알 수 있다.<a class="src-tag ans" href="#ev43">지문 근거</a></li>
    <li id="q38-5">⑤ ‘잔악한 도구를 휘두를 작정’에 ‘웃음이 터’지는 데서, 상황에 따라 달라지는 자신을 돌아봄을 알 수 있다.<a class="src-tag ans" href="#ev45">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  ...
  받들고 바라보니 천리에 뉘 전할고<br>
  싸고 다시 싸서 베개 맡에 놓아두고<br>
  사창(紗窓) 지는 달에 첫잠을 잠깐 드니<br>
  나비가 청조(靑鳥)되어 인도해서 가고 가니<br>
  옥루 높은 곳에 화촉이 찬란한데<br>
  ...
  줄줄이 슬픈 소리 내 마음 일렁인다<br>
  (…) 답답하고 그리운 때 하늘을 바라보니<br>
  넓고도 높은 기상 이 아니 님이신가<br>
  평생에 우러름이 진실로 하늘 같은 내 님이라<br>
  두어라 천명과 천시 정한 때 있으니<br>
  추당에 만부용* 되어 수홍*하며 기다리려 하노라</p>
  ...
  <p><span class="ev ans" id="ev50">이루어진 일을 보고서 무너질 일을 염려함은 나라를 소유한 군주가 먼저 힘써야 하는 일이요, 사건을 계기로 경계를 아룀은 임금을 사랑하는 신하의 마음입니다.</span><a class="ev-tag ans" href="#q42-5">42-⑤</a> 이것이 신이 반고·왕연수처럼 쓸데없는 말을 짓지 않고 송경의 「무일도」와 이덕유의 「단의잠」에 연연하는 이유입니다.</p>
...
<div class="q-block" id="prob39">
  ...
  <ul class="q-opts">
    <li id="q39-1">① (가)는 (나)와 달리 직유법으로 상황의 심각성을 부각한다.<a class="src-tag ans" href="#ev46">지문 근거</a></li>
    <li id="q39-2">② (가)는 (나)와 달리 음성상징어로 대상을 생생하게 묘사한다.<a class="src-tag ans" href="#ev46">지문 근거</a></li>
    ...
    <li id="q39-5">⑤ (가)와 (나) 모두 계절적 배경으로 대상의 속성을 강조한다.<a class="src-tag ans" href="#ev50">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob40">
  ...
  <ul class="q-opts">
    ...
    <li id="q40-3">③ ㉠은 화자가 이질감을 느끼는 대상, ㉡은 글쓴이가 동질감을 느끼는 대상이다.<a class="src-tag ans" href="#ev46">지문 근거</a></li>
    ...
    <li id="q40-5">⑤ ㉠은 화자가 지향하는 가치, ㉡은 글쓴이가 지양하는 가치를 지녔다고 보는 대상이다.<a class="src-tag ans" href="#ev50">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob41">
  ...
  <ul class="q-opts">
    <li id="q41-1">① ⓐ: 그림이 임금에게 생각을 불러일으킬 것이라는 추측을 나타낸다.<a class="src-tag ans" href="#ev46">지문 근거</a></li>
    ...
    <li id="q41-4">④ ⓓ: 임금이 보고 싶은 경관을 늘 가까이 두고 보려 한다는 추측을 나타낸다.<a class="src-tag ans" href="#ev50">지문 근거</a></li>
    <li id="q41-5">⑤ ⓔ: 병풍을 통해 후대 왕에게 현재 임금의 뜻이 이어지리라는 인식을 나타낸다.<a class="src-tag ans" href="#ev50">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
      <div class="question-analysis">
        ...
        <p>ⓒ는 반고·왕연수의 문장이 ‘아름답기야 하지만’ 임금을 <strong>경계·깨우치지 못해</strong> 다스림에 도움이 안 됐다는 뜻이다. ‘아름다움이 부족했다’는 게 아니므로 ③이 적절하지 않다.</p>
      </div>
      <table class="jt">
        <thead><tr><th>선지</th><th>판단</th><th>근거</th></tr></thead>
        <tbody>
...
<div class="q-block" id="prob42">
  <p class="q-stem">42. 〈보기〉를 바탕으로 (가), (나)를 감상한 내용으로 적절하지 <strong>않은</strong> 것은? <span class="q-pt-inline">[3점]</span> <span class="q-rate">오답률 41.7%</span></p>
  <div class="q-bogi">
    <p class="bogi-label">&lt; 보 기 &gt;</p>
  ...
  <ul class="q-opts">
    <li id="q42-1">① (가)의 ‘미나리’를 ‘천리에 뉘 전할고’에서 임금에게 닿을 수 없는 상황적 제약이 드러난다.<a class="src-tag ans" href="#ev46">지문 근거</a></li>
    <li id="q42-2">② (가)의 ‘장상사 한 곡조’에 ‘내 마음 일렁인다’에서 자신의 처지로 인한 서러움을 엿볼 수 있다.<a class="src-tag" href="#ev48">지문 근거</a></li>
    <li id="q42-3">③ (나)의 ‘병풍을 만들겠다’는 이유를 언급하는 데서 소양을 갖추려는 임금의 혜안을 강조한다.<a class="src-tag ans" href="#ev50">지문 근거</a></li>
    <li id="q42-4">④ (가)의 ‘첫잠’에 ‘옥루 높은 곳’에 가는 데서 간절한 그리움을, (나)의 ‘송경·이덕유’에 ‘연연’하는 데서 신하의 본분을 엿볼 수 있다.<a class="src-tag ans" href="#ev46">지문 근거</a></li>
...
<div class="passage">
  ...
  얼어붙은 심장 밑으로 흐르던<br>한 줄기 ㉠<u>가는</u> 어느 난류가 멈추고<br>㉡<span class="ev ans" id="ev-q44-2"><u>지치도록 고요한</u></span><a class="ev-tag ans" href="#q44-2">44-㉡</a> 하늘에 별도 얼어붙어<br><br>
  ...
  <span class="ev ans" id="ev53">스승은 낡은 구두처럼<br>새 것으로 바뀌지 않는다<br>그러나 새롭게 등장하는 것들을 어깨에 짊어지고<br>스승이 낡아가는 것인가</span><br>
...
<div class="q-block" id="prob43">
  ...
  <ul class="q-opts">
    <li id="q43-1">① (가)와 (나) 모두 명사로 시행을 마무리해 여운을 남긴다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
    <li id="q43-2">② (가)와 (나) 모두 특정 시어를 반복적으로 활용해 시적 상황을 부각한다.<a class="src-tag ans" href="#ev43">정답 근거</a></li>
    <li id="q43-3">③ (가)는 (나)와 달리 의문형 어미로 화자의 정서를 강조한다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
    <li id="q43-4">④ (나)는 (가)와 달리 하강의 이미지로 배경을 묘사한다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
    <li id="q43-5">⑤ (나)는 (가)와 달리 청자를 명시적으로 설정해 친근감을 드러낸다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob44">
  ...
  <ul class="q-opts">
    <li id="q44-1">① ㉠은 ‘심장 밑’에서 ‘흐르던’ ‘난류’의 미약함을 나타낸다.<a class="src-tag ans" href="#ev-q44-2">지문 근거</a></li>
    <li id="q44-2">② ㉡은 ‘하늘’이 ‘별’로 인해 ‘얼어붙’은 정적인 상태를 강조하는 표현이다.<a class="src-tag ans" href="#ev-q44-2">정답 근거</a></li>
    <li id="q44-3">③ ㉢은 ‘푸른 별’이 남김없이 ‘떨어질’ 극단적 상황을 나타낸다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
    <li id="q44-4">④ ㉣은 ‘구두’가 ‘낡아가’는 상황이 지속됨을 나타낸다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
    <li id="q44-5">⑤ ㉤은 ‘스승의 서재’가 충분히 오래된 공간임을 강조한다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob45">
  <p class="q-stem">45. 〈보기〉를 참고하여 윗글을 감상한 내용으로 적절하지 <strong>않은</strong> 것은? <span class="q-pt-inline">[3점]</span> <span class="q-rate">오답률 34.0%</span></p>
  <div class="q-bogi">
    <p class="bogi-label">&lt; 보 기 &gt;</p>
  ...
  <ul class="q-opts">
    <li id="q45-1">① (가)의 ‘하늘이 무너지고’ ‘지구가 정지’에서 시대적 현실로 인한 절망을 짐작할 수 있다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
    <li id="q45-2">② (가)의 ‘너’가 ‘아직 고운 심장을 지녔’다는 데서 생명력으로 냉혹한 현실을 극복할 수 있다는 희망을 짐작할 수 있다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
    <li id="q45-3">③ (나)의 ‘하룻밤새 또 건물’이 지어진다는 데서 빠른 도시화를 짐작할 수 있다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
    <li id="q45-4">④ (나)의 ‘스승’이 ‘새롭게 등장하는 것들을 어깨에 짊어지’는 데서 변화를 이끌어 가는 인물의 모습을 짐작할 수 있다.<a class="src-tag ans" href="#ev53">정답 근거</a></li>
    <li id="q45-5">⑤ (가)의 ‘밤이 이대로 억만 년이야 갈리라구’에서 현실 변화의 염원을, (나)의 ‘모든 것들이’ ‘먼저 낡아갈 것인가’에서 새로운 현실도 변할 것이라는 인식을 짐작할 수 있다.<a class="src-tag ans" href="#ev53">지문 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
  ...
  <div class="concept-grid">
    ...
    <div class="concept-card"><strong>자료 정확성</strong><span>‘크기’ vs ‘성별’처럼 핵심 단어 바꿔치기를 본다.</span></div>
    <div class="concept-card"><strong>청중 반응 분류</strong><span>탐색·아쉬움·긍정 평가·배경지식·신뢰 의문을 구분.</span></div>
  </div>
</div>
...
<div class="self-check">
  ...
  <ol>
    <li>2번에서 ④가 틀린 이유를 ‘크기/성별’ 단어로 설명해 보자.</li>
    <li>학생1의 반응은 ‘탐색’인가 ‘신뢰 의문’인가? 왜인가?</li>
  </ol>
</div>
