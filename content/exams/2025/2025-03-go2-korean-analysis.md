...
<div class="q-block" id="prob2">
  ...
  <ul class="q-opts">
    <li id="q2-1">① 구들장논이라는 이름의 이유를 설명하려 [자료1]을 활용했다.<a class="src-tag" href="#ev2-1">오답 근거</a></li>
    <li id="q2-2">② 일반 논의 지리적 입지 조건을 제시하려 [자료2]를 활용했다.<a class="src-tag" href="#ev2-2">오답 근거</a></li>
    <li id="q2-3">③ 청산도 구들장논에서 물을 효율적으로 쓰는 특징을 설명하려 [자료1]과 [자료2]를 활용했다.<a class="src-tag" href="#ev2-3">오답 근거</a></li>
    <li id="q2-4">④ 샛똘의 역할을 보여 주려 [자료1]과 [자료3]을 활용했다.<a class="src-tag" href="#ev2-4">오답 근거</a></li>
...
<div class="q-block" id="prob3">
  ...
  <ul class="q-opts">
    <li id="q3-1">① 학생1은 설명되지 않은 내용을 언급하며 아쉬워한다.<a class="src-tag" href="#ev3-1">오답 근거</a></li>
    <li id="q3-2">② 학생2는 추가적인 정보를 탐색하려 한다.<a class="src-tag" href="#ev3-2">오답 근거</a></li>
    <li id="q3-3">③ 학생3은 발표의 효용성을 근거로 긍정적으로 평가한다.<a class="src-tag" href="#ev3-use">오답 근거</a></li>
    ...
    <li id="q3-5">⑤ 학생2와 학생3은 모두 자신의 배경지식을 떠올린다.<a class="src-tag" href="#ev3-5a">오답 근거(학생2)</a><a class="src-tag" href="#ev3-5b">오답 근거(학생3)</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  <p class="passage-guide">[4 ~ 7] (가)는 ‘정보 보안 동아리’ 대화, (나)는 이를 바탕으로 ‘학생1’이 작성한 글이다.<span class="passage-legend"><b style="color:#1f7a3d;border-color:#1f7a3d">초록 밑줄</b>은 정답 근거, 옆 번호를 누르면 그 문제로 이동합니다.</span></p>
...
<div class="q-block" id="prob4">
  ...
  <ul class="q-opts">
    ...
    <li id="q4-5">⑤ 대화의 목적을 밝히며 참여를 유도한다.<a class="src-tag" href="#ev4a">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob5">
  ...
  <ul class="q-opts">
    <li id="q5-1">① [A]에서 학생3은 학생2의 내용과 관련해 자신이 아는 정보를 덧붙인다.<a class="src-tag" href="#ev5a">오답 근거</a></li>
    <li id="q5-2">② [A]에서 학생2는 학생3의 내용 일부를 재진술하며 궁금한 점을 확인한다.<a class="src-tag" href="#ev5b">오답 근거</a></li>
    <li id="q5-3">③ [B]에서 학생2는 학생3의 내용을 긍정하며 자신의 의견을 제시한다.<a class="src-tag" href="#ev5d">오답 근거</a></li>
    <li id="q5-4">④ [B]에서 학생3은 학생2의 내용에 동의하며 기대되는 효과를 언급한다.<a class="src-tag" href="#ev5c">오답 근거</a></li>
...
<div class="q-block" id="prob6">
  ...
  <ul class="q-opts">
    <li id="q6-1">① ‘다양한 활용’ 언급은 휴대 전화 잠금 해제·은행 거래로 구체화돼 반영됐다.<a class="src-tag" href="#ev6a">오답 근거</a></li>
    ...
    <li id="q6-5">⑤ 정보 주체의 노력에 ‘불필요한 정보 삭제 요청’이 추가돼 반영됐다.<a class="src-tag" href="#ev6c">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  ...
  <p>저는 □□공원 인근에 사는 고등학생입니다. 공원 내 다목적 운동장의 조명과 소음으로 주민들이 불편을 겪고 있어 글을 씁니다. <span class="ev" id="ev8-2">이 운동장은 다른 지역과 달리 24시까지 개방해 운동 모임이 많습니다.</span><a class="ev-tag" href="#q8-2">8-②</a></p>
...
<div class="q-block" id="prob8">
  ...
  <ul class="q-opts">
    <li id="q8-1">① 다목적 운동장의 빛에 따른 피해를 구체적 수치로 제시했다.<a class="src-tag" href="#ev8-1">오답 근거</a></li>
    <li id="q8-2">② 운동장이 인기 있는 이유를 구청 관계자의 말을 인용해 제시했다.<a class="src-tag" href="#ev8-2">오답 근거</a></li>
...
<div class="q-block" id="prob9">
  ...
  <ul class="q-opts">
    <li id="q9-1">① ㄱ-1: 소음이 건강에 미치는 영향을 ‘소음 알림판’ 내용으로 4문단에 추가.<a class="src-tag" href="#ev9-g1">오답 근거</a></li>
    <li id="q9-2">② ㄱ-2: 소등 21시가 가장 많다는 내용을 ‘21시 소등’ 근거로 3문단 보강.<a class="src-tag" href="#ev9-g2">오답 근거</a></li>
    <li id="q9-3">③ ㄷ: 방음벽이 미관상 좋지 않다는 내용을 ‘현수막 부착’ 이유로 4문단에 추가.<a class="src-tag ans" href="#ev9-d-ans">정답 근거</a></li>
    <li id="q9-4">④ ㄱ-1·ㄴ: 빛·소음의 건강상 악영향을 ‘주민의 부정적 문제 사례’로 2문단 구체화.<a class="src-tag" href="#ev9-g1">오답 근거</a><a class="src-tag" href="#ev9-n">오답 근거</a></li>
    <li id="q9-5">⑤ ㄴ·ㄷ: 바닥 조명·나무 심기를 ‘빛 차단 대안’으로 3문단에 추가.<a class="src-tag" href="#ev9-n">오답 근거</a><a class="src-tag" href="#ev9-d">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob10">
  ...
  <ul class="q-opts">
    <li id="q10-1">① 건의 내용과 무관한 내용을 삭제하는 게 어때?<a class="src-tag" href="#ev10-1">오답 근거</a></li>
    <li id="q10-2">② 건의 목적에 부합하는 새로운 해결 방안을 추가하는 게 어때?</li>
    <li id="q10-3">③ 건의가 공동체를 위한 것임을 드러내는 것으로 바꾸는 게 어때?<a class="src-tag" href="#ev10-3">오답 근거</a></li>
    <li id="q10-4">④ 건의를 받는 독자의 예상되는 어려움을 구체적으로 밝히는 게 어때?<a class="src-tag" href="#ev10-4">오답 근거</a></li>
    <li id="q10-5">⑤ 독자가 건의 수용을 통해 얻을 이점을 제시하는 게 어때?<a class="src-tag" href="#ev10-5">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob11">
  ...
  <ul class="q-opts">
    <li id="q11-1">① 현대 국어 관형격 ‘의’는 [ㅢ]나 [ㅔ]로 발음할 수 있다.<a class="src-tag" href="#ev11-pron">오답 근거</a></li>
    <li id="q11-2">② 중세 국어 관형격은 유정 체언과 결합할 때 존대 대상 여부에 따라 형태가 달랐다.<a class="src-tag" href="#ev12">오답 근거</a></li>
    <li id="q11-3">③ 현대 국어와 달리, 중세 국어 관형격 조사는 체언 뒤에 결합해 이동의 도착점을 나타내는 부사어를 이룰 수 있다.<a class="src-tag ans" href="#ev11">정답 근거</a></li>
    <li id="q11-4">④ 현대·중세 모두 관형격 조사는 여러 의미를 나타낼 수 있다.<a class="src-tag" href="#ev11-mean">오답 근거</a></li>
    <li id="q11-5">⑤ 현대·중세 모두 관형격 조사는 체언 뒤에 결합해 관형어를 이룬다.<a class="src-tag" href="#ev11">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob12">
  ...
  <div class="q-bogi">
    <p class="bogi-label">&lt; 보 기 &gt;</p>
    <p>ㄱ. <span class="ev" id="ev12-g">아ᄃᆞᄅᆡ(아ᄃᆞᆯ+ᄋᆡ) 손 자바</span><a class="ev-tag" href="#q12-1">12-①</a> [아들의 손을 잡아]<br>
    ㄴ. <span class="ev" id="ev12-n">수픐(수플+ㅅ) 가온ᄃᆡ</span><a class="ev-tag" href="#q12-2">12-②</a> [수풀의 가운데]<br>
    ㄷ. <span class="ev ans" id="ev12-d">그 무더믜(무덤+의) ᄂᆞᆯ아가아</span><a class="ev-tag ans" href="#q12-3">12-③</a> [그 무덤에 날아가서]<br>
    ㄹ. <span class="ev" id="ev12-r">서리예(서리+예)</span><a class="ev-tag" href="#q12-4">12-④</a> [서리에]<br>
    ㅁ. <span class="ev" id="ev12-m">아ᄎᆞᄆᆡ(아ᄎᆞᆷ+ᄋᆡ) 닉더니</span><a class="ev-tag" href="#q12-5">12-⑤</a> [아침에 익더니]</p>
  </div>
  <ul class="q-opts">
    <li id="q12-1">① ㄱ ‘아ᄃᆞᄅᆡ’의 ‘ᄋᆡ’는 음성 모음 유정 체언 뒤라 ⓐ를 나타낸다.<a class="src-tag" href="#ev12-g">오답 근거</a></li>
    <li id="q12-2">② ㄴ ‘수픐’의 ‘ㅅ’은 무정 체언 뒤라 ⓑ를 나타낸다.<a class="src-tag" href="#ev12-n">오답 근거</a></li>
    <li id="q12-3">③ ㄷ ‘무더믜’의 부사격 ‘의’는 음성 모음 체언 뒤라 ⓒ(도착점)를 나타낸다.<a class="src-tag ans" href="#ev12-d">정답 근거</a></li>
    <li id="q12-4">④ ㄹ ‘서리예’의 ‘예’는 반모음 ‘ㅣ’로 끝난 체언 뒤라 ⓓ를 나타낸다.<a class="src-tag" href="#ev12-r">오답 근거</a></li>
    <li id="q12-5">⑤ ㅁ ‘아ᄎᆞᄆᆡ’의 부사격 ‘ᄋᆡ’는 양성 모음 체언 뒤라 ⓔ를 나타낸다.<a class="src-tag" href="#ev12-m">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob15">
  ...
  <ul class="q-opts">
    <li id="q15-1">① ㉠은 교체·축약이 한 번씩 일어나 개수가 줄었다.<a class="src-tag" href="#ev15-1">오답 근거</a></li>
    <li id="q15-2">② ㉡은 탈락·첨가가 한 번씩 일어나 개수가 변하지 않았다.<a class="src-tag ans" href="#ev15-2">정답 근거</a></li>
    <li id="q15-3">③ ㉢은 교체가 두 번 일어나 개수가 변하지 않았다.<a class="src-tag" href="#ev15-3">오답 근거</a></li>
    <li id="q15-4">④ ㉣은 교체 두 번·첨가 한 번 일어나 개수가 늘었다.<a class="src-tag" href="#ev15-4">오답 근거</a></li>
    <li id="q15-5">⑤ ㉤은 첨가·교체가 한 번씩 일어나 개수가 늘었다.<a class="src-tag" href="#ev15-5">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  <p class="passage-guide">[16 ~ 21] 다음 글을 읽고 물음에 답하시오.<span class="passage-legend"><b style="color:#1f7a3d;border-color:#1f7a3d">초록 밑줄</b>은 정답 근거입니다. 옆 번호를 누르면 그 문제로 이동합니다.</span></p>
...
<div class="q-block" id="prob17">
  ...
  <ul class="q-opts">
    <li id="q17-1">① 로크는 사례를 들어 본유 관념의 존재를 부정했다.<a class="src-tag" href="#ev16a">오답 근거</a></li>
    <li id="q17-2">② 로크는 필연적 진리가 인간의 경험에서 기원한다고 보았다.<a class="src-tag" href="#ev16c">오답 근거</a></li>
    <li id="q17-3">③ 라이프니츠는 지식 획득에 대한 로크 주장의 한계를 파악했다.<a class="src-tag" href="#ev16f">오답 근거</a></li>
    <li id="q17-4">④ 라이프니츠는 필연적 진리와 사실적 진리 모두 반드시 참인 명제로 보았다.<a class="src-tag ans" href="#ev16d">정답 근거</a></li>
    <li id="q17-5">⑤ 라이프니츠는 로크의 본유 관념 비판이 자신의 단자론 비판이 될 수 있다고 보았다.<a class="src-tag" href="#ev16f">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob19">
  ...
  <ul class="q-opts">
    <li id="q19-1">① ㉠은 로크에게, 동일률·모순율이 본유적이지 않다는 근거가 된다.<a class="src-tag" href="#ev16a">오답 근거</a></li>
    <li id="q19-2">② ㉠은 라이프니츠에게, 아이가 본유 관념을 자각하지 못해 생긴 결과다.<a class="src-tag" href="#ev16e">오답 근거</a></li>
    <li id="q19-3">③ ㉡은 로크에게, 일반화하는 추상 작용을 거치면 거짓으로 인정된다.<a class="src-tag ans" href="#ev16b">정답 근거</a></li>
    <li id="q19-4">④ ㉡은 라이프니츠에게, 본유 관념으로 추론한 지식이 아니다.<a class="src-tag" href="#ev16b">오답 근거</a></li>
    <li id="q19-5">⑤ ㉡은 로크와 라이프니츠 모두에게, 감각적 경험에서 비롯된 지식이다.<a class="src-tag" href="#ev16b">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob20">
  ...
  <ul class="q-opts">
    <li id="q20-1">① A의 규칙이 언어적 자극에서 시작된 학습이라는 점에서, 본유론자는 A를 본유적으로 보지 않는다.<a class="src-tag" href="#ev16by">오답 근거</a></li>
    <li id="q20-2">② A의 아동이 규칙 전에 자극을 받는다는 점에서, 로크는 A 규칙을 경험에서 비롯된 것으로 본다.<a class="src-tag" href="#ev16c">오답 근거</a></li>
    <li id="q20-3">③ B의 보편 규칙이 태어날 때부터 지닌 것이라는 점에서, 본유론자는 B를 본유적으로 본다.<a class="src-tag" href="#ev16by">오답 근거</a></li>
    <li id="q20-4">④ B의 보편 규칙이 필연적이라는 점에서, 라이프니츠는 그것을 자각한 모두의 보편 동의가 명백하다고 본다.<a class="src-tag" href="#ev16e">오답 근거</a></li>
...
<div class="passage">
  <p class="passage-guide">[22 ~ 26] 다음 글을 읽고 물음에 답하시오.<span class="passage-legend"><b style="color:#1f7a3d;border-color:#1f7a3d">초록 밑줄</b>은 정답 근거입니다. 옆 번호를 누르면 그 문제로 이동합니다.</span></p>
...
<div class="q-block" id="prob22">
  ...
  <ul class="q-opts">
    <li id="q22-1">① 인지대는 소송 비용 중 재판 비용에 포함된다.<a class="src-tag" href="#ev22a">오답 근거</a></li>
    <li id="q22-2">② 변호사 비용은 소송 서류의 작성료 등 당사자 비용을 포함한다.<a class="src-tag ans" href="#ev22b">정답 근거</a></li>
    <li id="q22-3">③ 민사 소송은 소송 당사자가 법원에 소장을 제출하면 시작된다.<a class="src-tag" href="#ev22n">오답 근거</a></li>
    <li id="q22-4">④ 공익 소송에서 당사자가 승소하면 이익이 사회 전체로 돌아갈 수 있다.<a class="src-tag" href="#ev22r">오답 근거</a></li>
    <li id="q22-5">⑤ 법원의 결정에 따라 일부 패소한 측에 소송 비용 일부를 부담시킬 수 있다.<a class="src-tag" href="#ev22p">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob25">
  ...
  <ul class="q-opts">
    ...
    <li id="q25-2">② A·공사 모두 변호사를 선임한 것은 소송에서 소송 대리인을 내세운 것이다.<a class="src-tag" href="#ev22b">오답 근거</a></li>
    <li id="q25-3">③ A의 차별구제청구 소송은 불합리한 사회 문제를 개선해 국민 권리를 회복하려는 소송이다.<a class="src-tag" href="#ev22r">오답 근거</a></li>
    <li id="q25-4">④ A에게 소송 비용 전부를 지급하라는 판결은 경제적 부담으로 공익 활동을 위축시킬 수 있다.<a class="src-tag" href="#ev22r">오답 근거</a></li>
    <li id="q25-5">⑤ 각자 부담주의였다면 공사가 승소해도 A·공사 각자가 변호사 비용을 부담했을 것이다.<a class="src-tag" href="#ev22ga">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  <p class="passage-guide">[27 ~ 30] 다음 글을 읽고 물음에 답하시오.<span class="passage-legend"><b style="color:#1f7a3d;border-color:#1f7a3d">초록 밑줄</b>은 정답 근거입니다. 옆 번호를 누르면 그 문제로 이동합니다.</span></p>
...
<div class="q-block" id="prob28">
  ...
  <ul class="q-opts">
    <li id="q28-1">① ㉠의 ‘수행한 일’은 고온 열원에서 받은 열의 양보다 크지 않다.<a class="src-tag" href="#ev27a">오답 근거</a></li>
    <li id="q28-2">② ㉡의 COPH가 커지면 COPC도 커진다.<a class="src-tag" href="#ev27b">오답 근거</a></li>
    <li id="q28-3">③ ㉡의 COPH는 COPC보다 큰 값을 갖지 않는 경우가 있다.<a class="src-tag ans" href="#ev27b">정답 근거</a></li>
    <li id="q28-4">④ ㉠은 1보다 작고 ㉡의 COPH는 1보다 크다.<a class="src-tag" href="#ev27a">오답 근거</a></li>
    <li id="q28-5">⑤ ㉠·㉡ 모두 들어가는 열당 방출하는 열의 비가 바뀌면 값이 바뀐다.<a class="src-tag" href="#ev27m">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob33">
  ...
  <ul class="q-opts">
    <li id="q33-1">① ㉠: 남에게 과시하고 싶은 욕구가 드러난다.<a class="src-tag" href="#ev33a">오답 근거</a></li>
    <li id="q33-2">② ㉡: 노인의 말에 동의하지 않음이 나타난다.<a class="src-tag" href="#ev33-2">오답 근거</a></li>
    <li id="q33-3">③ ㉢: 노인을 돕겠다는 의지가 드러난다.<a class="src-tag ans" href="#ev-q33-3">정답 근거</a></li>
    <li id="q33-4">④ ㉣: 전날 사건으로 노인에게 상처를 주었다는 성찰이 드러난다.<a class="src-tag" href="#ev33-4">오답 근거</a></li>
    <li id="q33-5">⑤ ㉤: 여전히 의연한 노인에 대한 심리가 나타난다.<a class="src-tag" href="#ev32b">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob34">
  ...
  <ul class="q-opts">
    <li id="q34-1">① ‘법도도 법도지만 마음이 다르오’에서 노인이 활쏘기를 자기 수양으로 봄을 알 수 있다.<a class="src-tag" href="#ev34a">오답 근거</a></li>
    <li id="q34-2">② 딸의 솜씨를 ‘볼 만한 게 못 된다’고 거절하는 데서 노인이 흥밋거리 시선에 거부감을 느낌을 알 수 있다.<a class="src-tag" href="#ev34b">오답 근거</a></li>
    <li id="q34-3">③ ‘굳이 시범을 강청’하는 데서 일행이 활쏘기를 대상화될 기술로 봄을 알 수 있다.<a class="src-tag" href="#ev34b">오답 근거</a></li>
    <li id="q34-4">④ ‘새벽 활쏘기에 자리를 피해’ 준 데서 석주호가 활쏘기를 궁도로 존중하려 함을 알 수 있다.<a class="src-tag" href="#ev34c">오답 근거</a></li>
...
<div class="q-block" id="prob35">
  ...
  <ul class="q-opts">
    <li id="q35-1">① 임금은 장선빙을 신하로 얻은 후 자식처럼 아꼈다.<a class="src-tag" href="#ev35f">오답 근거</a></li>
    <li id="q35-2">② 신하들은 두 사람을 모두 쓰겠다는 임금의 뜻에 따랐다.<a class="src-tag" href="#ev37a">오답 근거</a></li>
    <li id="q35-3">③ 김희경은 자신과 장선빙의 약속을 임금이 헤아릴 것이라 예상했다.<a class="src-tag" href="#ev35b">오답 근거</a></li>
    <li id="q35-4">④ 장선빙은 사당에서 여자로 돌아가리라 고한 후 임금의 답을 받았다.<a class="src-tag ans" href="#ev35">정답 근거</a></li>
    <li id="q35-5">⑤ 최후는 두 글의 우열이 안 가려지자 둘을 임금 앞에 부르자고 아뢰었다.<a class="src-tag" href="#ev35c">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob38">
  ...
  <ul class="q-opts">
    ...
    <li id="q38-3">③ ‘병부 상서 자리’에서 물러난 데서 성취가 일부 환수되는 모습을 본다.<a class="src-tag" href="#ev35">오답 근거</a></li>
    <li id="q38-4">④ ‘태학사’는 유지하되 ‘요조숙녀’로 변하는 데서 능력 인정과 관습 얽매임을 모두 본다.<a class="src-tag" href="#ev35">오답 근거</a></li>
...
<div class="passage">
  <p class="passage-guide">[39 ~ 41] 다음 글을 읽고 물음에 답하시오.<span class="passage-legend"><b style="color:#1f7a3d;border-color:#1f7a3d">초록 밑줄</b>은 정답 근거입니다.</span></p>
...
<div class="q-block" id="prob40">
  ...
  <ul class="q-opts">
    ...
    <li id="q40-2">② (가) ‘껍데기’가 ‘무거웁’다는 것은 ‘성씨보와 같은 관습’의 중압감을 드러낸다.<a class="src-tag" href="#ev40a">오답 근거</a></li>
    <li id="q40-3">③ (나) ‘꽉’은 화자가 처한 상황의 답답함을 부각한다.<a class="src-tag" href="#ev40c">오답 근거</a></li>
...
<div class="q-block" id="prob41">
  ...
  <ul class="q-opts">
    <li id="q41-1">① (가) ‘가계보’를 ‘창작·매매’ 대상으로 표현한 데서 족보가 속물화된 모습을 안다.<a class="src-tag" href="#ev41a">오답 근거</a></li>
    <li id="q41-2">② (가) ‘이기적인 애욕을 잊으려’는 데서 인습에 근거한 이기적 욕망 거부를 안다.<a class="src-tag" href="#ev41b">오답 근거</a></li>
    <li id="q41-3">③ (나) ‘4원에 사가지고’ 온 것으로 ‘생활을 보일 수 없’다는 데서 속물성 확인을 안다.<a class="src-tag" href="#ev41c">오답 근거</a></li>
    <li id="q41-4">④ (가) ‘할아버지 성씨를 알 수도 없다’에서 족보를 허위로 봄을, (나) ‘식모 부르는 소리가 단호’에서 자기 부정적 인식을 안다.<a class="src-tag" href="#ev41d">오답 근거</a></li>
...
<div class="q-block" id="prob43">
  ...
  <ul class="q-opts">
    <li id="q43-1">① ㉠: 주변을 돌아다니며 자연을 감상하는 모습을 형상화한다.<a class="src-tag" href="#ev43-1">오답 근거</a></li>
    <li id="q43-2">② ㉡: 자연을 즐기되 생계를 위한 일에도 소홀하지 않는 모습을 나타낸다.<a class="src-tag" href="#ev43-2">오답 근거</a></li>
    <li id="q43-3">③ ㉢: 자연에서의 삶에 대한 기대와 현실의 차이에서 비롯된 아쉬움을 드러낸다.<a class="src-tag ans" href="#ev43">정답 근거</a></li>
    <li id="q43-4">④ ㉣: 상대의 앞날에 대한 전망을 드러내려 상황을 가정한다.<a class="src-tag" href="#ev43-4">오답 근거</a></li>
    <li id="q43-5">⑤ ㉤: 장소의 특성 때문에 쓰임에 제약이 있는 상황을 표현한다.<a class="src-tag" href="#ev44b">오답 근거</a></li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob45">
  ...
  <ul class="q-opts">
    ...
    <li id="q45-2">② (나) ‘기회를 만나게 될 것이오’와 ‘무엇을 바라겠습니까’에서 손님·글쓴이의 태도 차이를 본다.<a class="src-tag" href="#ev45">오답 근거</a></li>
    <li id="q45-3">③ (나) ‘아무도 길어 가지 않아도 늘 비어 있을 까닭 없다’에서 상황과 무관히 덕·도를 지키려는 태도를 본다.<a class="src-tag" href="#ev45">오답 근거</a></li>
