...
<div class="passage">
  ...
  <p>㉡<u>성적 계수</u>는 고온부(COPH, 전기 에너지당 고온으로 전달된 열)와 저온부(COPC, 전기 에너지당 저온에서 받은 열)로 나뉜다. 열역학 제1법칙(에너지 보존)에 따라 <span class="ev" id="ev27m">㉮한 사이클 순환 시 ‘저온에서 받은 열 + 투입 전기 에너지 = 고온으로 전달한 열’이다.</span> 양변을 전기 에너지로 나누면 <span class="ev ans" id="ev27b">COPH = COPC + 1</span><a class="ev-tag ans" href="#q28-3">28-③</a>이며, 하나가 바뀌면 다른 하나도 바뀐다.</p>
