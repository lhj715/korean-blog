...
<div class="passage">
  ...
  <p>([자료 1] 제시) 청산도 구들장논은 ‘석축’을 쌓고 자갈·흙을 얹어 만듭니다. 석축 하부의 물 빠지는 ‘통수로’ 위 넓적한 돌이 온돌의 구들장과 닮아 ‘구들장논’이라 부릅니다.</p>
  <p>([자료 2]·[자료 3] 제시) 일반 논은 넓은 평야에 만들지만, 청산도는 땅이 좁고 돌이 많아 산비탈에 계단처럼 논을 만들고 석축으로 평평한 면을 냈습니다 — 불리한 지형을 극복한 선조의 지혜입니다.</p>
  <p>물 이용에도 지혜가 있습니다. 통수로는 상부 논에서 쓴 물을 하부 논으로 흘려보내 재사용합니다. 다만 ‘샛똘’이라는 보조 수로로 물이 하부로 가지 않게 막기도 합니다. <span class="ev ans" id="ev1">만약 하부 논을 채우려 할 때는 어떻게 할까요? (대답을 듣고) 맞습니다. 샛똘을 열어 물이 하부 논으로 흘러가게 합니다. 물의 흐름·양을 조절하려 샛똘을 만든 것이지요.</span><a class="ev-tag ans" href="#q1-1">1-①</a></p>
...
<div class="q-block" id="prob2">
  ...
  <ul class="q-opts">
    <li id="q2-1">① 구들장논이라는 이름의 이유를 설명하려 [자료1]을 활용했다.</li>
    <li id="q2-2">② 일반 논의 지리적 입지 조건을 제시하려 [자료2]를 활용했다.</li>
    <li id="q2-3">③ 청산도 구들장논에서 물을 효율적으로 쓰는 특징을 설명하려 [자료1]과 [자료2]를 활용했다.</li>
    <li id="q2-4">④ 샛똘의 역할을 보여 주려 [자료1]과 [자료3]을 활용했다.</li>
    <li id="q2-5">⑤ 일반 논에서 논농사 짓기 어려운 지형 특징을 설명하려 [자료2]와 [자료3]을 활용했다.</li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  ...
  <p>학생2: 생체 정보 중 특정 개인을 인증·식별하려 처리하는 정보가 생체 인식 정보야. / 학생3: 지문·음성이 그렇지. 근데 일반 생체 정보로 보는 자료도 있어 — 구분이 모르겠어. / 학생2: <span class="ev" id="ev5b">‘둘이 어떻게 구분되는지 알고 싶다는 거지?’ 인증·식별에 쓰면 생체 인식 정보, 성별 등 확인에 쓰면 일반 생체 정보야.</span> / 학생3: <span class="ev ans" id="ev5">친구들과 얘기해 보니 친구들도 이 둘을 잘 구분 못하더라고.</span><a class="ev-tag ans" href="#q5-5">5-[A]</a> 차이점을 설명하면 도움이 될 거야.</p></div>
