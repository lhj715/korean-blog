...
<div class="passage">
  ...
  <p>또 식물은 의사소통도 합니다. (도표 제시) <span class="ev ans" id="ev2">세균에 감염된 리마콩 옆 건강한 리마콩의 살리실산 비율이 평상시보다 높습니다. 감염된 리마콩이 내뿜은 살리실산메틸을 인지한 건강한 리마콩이 방어를 위해 살리실산을 생성한 것입니다.</span><a class="ev-tag" href="#q2-4">2-④</a></p>
...
<div class="passage">
  ...
  <p>학생3: 우리 학교 주변 갈대숲도 도움이 되겠네. 주변 환경만 고려하면 돼? / 학생2: 아니야. 수심·바닥 토양 두께를 달리해 다양한 생물이 살게 해야 해. / 학생3: 부레옥잠 같은 식물도 좋겠어. / 학생2: <span class="ev ans" id="ev5b">번식력이 왕성한 부레옥잠이 햇빛·물 흐름을 막아 생태계를 해칠 수도 있어 관리를 잘해야 해.</span><a class="ev-tag ans" href="#q5-5">5-⑤</a></p></div>
  <p>학생1: 생태 연못의 필요성·가치를 알리자. 교지에 기고할 차례니 내가 초고를 쓸게.</p>
  <p class="src-label">(나) 교지 글 초고</p>
  <p>휴게 공간으로 조성됐던 학교 연못이 방치되고 있다. <span class="ev ans" id="ev6a">이는 학교 연못을 인간 중심적 관점에서 조성한 결과이다.</span><a class="ev-tag ans" href="#q6-1">6-①</a> 우리가 되살릴 연못은 생태주의적 관점에서 조성되어야 한다. <span class="ev" id="ev6b">생태 철학자 네스는 인간 관점에서 자연을 이용·대할지 생각해선 안 되며 생태계와 인간의 조화가 필요하다고 주장한다.</span><a class="ev-tag" href="#q6-2">6-②</a></p>
...
<div class="passage">
  ...
  <p>전원 공급 → 상하부 전극 사이에 전기장 형성 → 수분 유지 기판에는 전기 흐르지 않지만 분자 내 전자·원자핵 재배열(분극) → <span class="ev ans" id="ev26">기판 표면에 서로 다른 전하 분포 → 정전용량의 기본값 형성(수분 유지 기판의 분극에 영향, 부도체에 축적된 전하의 양과는 무관).</span><a class="ev-tag" href="#q26-2">26-②</a></p>
...
<div class="passage">
  ...
  <p>지역권 비교 — <span class="ev ans" id="ev33">㉡상린권</span><a class="ev-tag" href="#q33-5">33-⑤</a>: 경계 인접 토지 소유권자들이 토지를 원만히 이용하도록 상호 조절하는 권리. 별도 등기 불필요. ㉠지역권은 별도 계약·등기가 필요하다.</p>
</div>
