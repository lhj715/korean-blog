...
<div class="q-block" id="prob2">
  ...
  <ul class="q-opts">
    ...
    <li id="q2-2">② ㉡: 흥미를 끌기 위해 영화 속 나무 캐릭터를 동영상으로 제시.</li>
    <li id="q2-3">③ ㉢: 시간 측정을 위해 두 피토크롬의 비율 차이를 그래프로 제시.</li>
    <li id="q2-4">④ ㉣: 의사소통 결과를 설명하려 감염된 리마콩이 생성하는 살리실산메틸 비율을 도표로 제시.<a class="src-tag ans" href="#ev2">정답 근거</a></li>
    <li id="q2-5">⑤ ㉤: 추가 조사를 위해 QR 코드를 제시.</li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="q-block" id="prob3">
  ...
  <div class="q-bogi">
    ...
    <p>학생1: 리마콩이 딱정벌레에 물릴 때도 화학 기체를 방출한다고 아는데, 그건 안 알려 줘 아쉬워. / 학생2: 면역 체계가 인간·동물에만 있는 줄 알았는데 식물도 방어 호르몬을 분비하는구나. 다른 호르몬도 있을까? 과학 선생님께 여쭤봐야지. / 학생3: 유익했어. 집에서 키우는 식물이 만지면 움츠러드는 이유도 인지 행동일 수 있겠네. 도서관에서 조사해 봐야지.</p>
  </div>
  <ul class="q-opts">
    <li id="q3-1">① 학생1은 발표 주제 관련 배경지식을 떠올리고 있다.</li>
    <li id="q3-2">② 학생2는 기존 지식을 수정하고 있다.</li>
    <li id="q3-3">③ 학생3은 경험을 토대로 발표자가 언급하지 않은 내용을 추론하고 있다.</li>
    <li id="q3-4">④ 학생1과 학생3은 모두 알고 싶은 정보가 다뤄지지 않음을 아쉬워하고 있다.<a class="src-tag ans" href="#ev3">정답 근거</a></li>
    <li id="q3-5">⑤ 학생2와 학생3은 모두 궁금증 해결을 위해 추가 활동을 계획하고 있다.</li>
  </ul>
  <details class="solution">
    <summary>해설 보기</summary>
    <div class="solution-body">
...
<div class="passage">
  ...
  <p>학생1: 생태 연못의 필요성·가치를 알리자. 교지에 기고할 차례니 내가 초고를 쓸게.</p>
...
<div class="passage">
  ...
  <p>해결책으로 <span class="ev ans" id="ev8">① 폐기 방식 인식 개선(교육·홍보) ② 수거 기준 보완(‘부품 불량·잠금장치 없는 자전거 수거’ 등 조항 추가) ③ 처리 방법 다양화(재활용 등)</span><a class="ev-tag ans" href="#q8-3">8-③</a>를 다양한 측면에서 제시한다.</p>
...
<div class="passage">
  ...
  <p>㉮ <span class="ev ans" id="ev11">보조적 연결 어미 ‘-고’는 본용언에 보조 용언을 이어 주며, 이때 ‘-고’ 뒤에 ‘-서’가 붙을 수 없다.</span><a class="ev-tag" href="#q11-1">11</a> 이어진문장에서 ‘-고’는 ㉠<span class="ev" id="ev12a">동작·상태의 나열(앞뒤 절 주어가 달라도 되고, 시제 선어말 어미가 앞뒤 절에 모두 쓰일 수 있으며, 순서를 바꿀 수 있음)</span><a class="ev-tag" href="#q12-1">12-①</a>을 나타낸다.</p>
  <p>종속적인 경우(주어 동일·시제 선어말 어미 불가·순서 못 바꿈)에는 ㉡<span class="ev ans" id="ev12c">앞 절 사건이 끝난 뒤 뒤 절이 연달아 일어남(앞 절 동사 [+완결성])</span><a class="ev-tag ans" href="#q12-4">12-④</a>, ㉢<span class="ev" id="ev12b">앞 절 동작의 결과가 지속되는 가운데 뒤 절 동작이 일어남(앞 절 동사 [+완결성][+지속성])</span><a class="ev-tag" href="#q12-3">12-③</a>이 있다. (예: ‘찍고’=[+완결][-지속]→순차, ‘쥐고’=[+완결][+지속]→지속)</p>
</div>
...
<div class="passage">
  ...
  <p>아리스토텔레스는 예술작품을 현실 세계를 모방한 사물로 보았다. 사물은 <strong>질료</strong>(물질적 재료)와 <strong>형상</strong>(보편적 개념·가치·본질)으로 구성된다. <span class="ev ans" id="ev16a">예술가는 자신이 이해한 사물의 형상을 질료에 담아 예술작품으로 재현하고, 감상자는 예술작품을 통해 형상을 이해한다.</span><a class="ev-tag ans" href="#q16-3">16-③</a></p>
  <p>실러는 아름다움이라는 형상을 질료에 담으면 감상자가 미적 경험으로 도덕성을 회복할 수 있다고 보았다. 또 <span class="ev ans" id="ev17a">미적 경험을 극대화하려면 예술작품의 질료가 지닌 물리적 성질이 드러나지 않아야 한다고 주장한다. 결국 <strong>ⓐ예술작품의 질료가 투명한 매체로 기능해야</strong> 한다.</span><a class="ev-tag ans" href="#q17-5">17-ⓐ</a></p>
...
<div class="passage">
  ...
  <p>전원 공급 → 상하부 전극 사이에 전기장 형성 → 수분 유지 기판에는 전기 흐르지 않지만 분자 내 전자·원자핵 재배열(분극) → <span class="ev ans" id="ev26">기판 표면에 서로 다른 전하 분포 → 정전용량의 기본값 형성(수분 유지 기판의 분극에 영향, 부도체에 축적된 전하의 양과는 무관).</span><a class="ev-tag ans" href="#q26-2">26-②</a></p>
...
<div class="passage">
  ...
  <p><strong>지상권</strong>: 다른 사람 토지에서 지상물을 소유하기 위해 토지를 이용하는 권리. <span class="ev ans" id="ev30a">토지 소유권이 제삼자에게 이전되어도 기존 지상권은 영향 받지 않으며, 지상권자는 소유권자 의사와 관계없이 지상권을 타인에게 이전할 수 있다.</span><a class="ev-tag" href="#q30-4">30-④</a> 지상권이 설정되면 지상권자가 해당 토지를 <strong>배타적으로</strong> 점유·이용한다.</p>
  ...
  <p>지역권 비교 — <span class="ev ans" id="ev33">㉡상린권</span><a class="ev-tag ans" href="#q33-5">33-⑤</a>: 경계 인접 토지 소유권자들이 토지를 원만히 이용하도록 상호 조절하는 권리. 별도 등기 불필요. ㉠지역권은 별도 계약·등기가 필요하다.</p>
</div>
...
<div class="passage">
  ...
  <p>귀졸들이 태종을 에워싸자 최 판관은 <span class="ev ans" id="ev39">높은 데 올라가 먼저 이를 인지하고 태종에게 알린다.</span><a class="ev-tag" href="#q39-5">39-⑤</a> 계교가 없다며 탄식하다, 판관 권위로 귀졸들을 물러서게 한 뒤 ㉠태종의 창고(빈 창고)로 안내한다.</p>
  ...
  <p>최 판관이 ㉡<span class="ev ans" id="ev41">장상의 창고(금은이 쌓임 — 장상은 평생 적선한 인물)</span><a class="ev-tag ans" href="#q41-5">41-㉡</a>로 안내해 금을 꾸어 귀졸들에게 나누어 주니 귀졸들이 물러선다.</p>
